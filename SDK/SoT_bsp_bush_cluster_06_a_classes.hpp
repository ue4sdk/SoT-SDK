...
public:
	...
	class UStaticMeshComponent*                        wsp_rock_xtra_small_e_01;                                 // 0x04E8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USceneComponent*                             SharedRoot;                                               // 0x04F0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass bsp_bush_cluster_06_a.bsp_bush_cluster_06_a_C");
		return ptr;
	}
