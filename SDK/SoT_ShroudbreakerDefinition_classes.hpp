...
#include "SoT_ShroudbreakerDefinition_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass ShroudbreakerDefinition.ShroudbreakerDefinition_C"));
		return ptr;
	}
