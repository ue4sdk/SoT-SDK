...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_ResourceIslandSunkenTreasureArtifactsSpawner.BP_ResourceIslandSunkenTreasureArtifactsSpawner_C");
		return ptr;
	}
