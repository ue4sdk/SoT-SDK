...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_FeatureIslandWashedUpMessageInABottleSpawner.BP_FeatureIslandWashedUpMessageInABottleSpawner_C");
		return ptr;
	}
