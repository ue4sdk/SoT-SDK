...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_FeatureIslandWashedUpMessageInABottleSpawner.BP_FeatureIslandWashedUpMessageInABottleSpawner_C");
		return ptr;
	}
