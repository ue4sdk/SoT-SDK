...
public:
	...
	class UStaticMeshComponent*                        shp_flag_pennant_01_b;                                    // 0x0A98(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        shp_flag_pennant_pole_01_a;                               // 0x0AA0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
