...
public:
	...
	UStaticMeshComponent*                              shp_flag_pennant_01_b;                                    // 0x0A00(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	UStaticMeshComponent*                              shp_flag_pennant_pole_01_a;                               // 0x0A08(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
