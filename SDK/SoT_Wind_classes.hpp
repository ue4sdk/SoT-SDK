...
public:
	...
	class AWindDirectionalSource*                      GlobalWindSource;                                         // 0x04B0(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x10];                                      // 0x04B8(0x0010) MISSED OFFSET
	float                                              CurrentWindAngle;                                         // 0x04C8(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	float                                              CurrentWindMagnitude;                                     // 0x04CC(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xE0];                                      // 0x04D0(0x00E0) MISSED OFFSET
	TArray<class UObject*>                             WindZones;                                                // 0x05B0(0x0010) (Net, ZeroConstructor)
