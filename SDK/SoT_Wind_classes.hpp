...
public:
	...
	class AWindDirectionalSource*                      GlobalWindSource;                                         // 0x0488(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x10];                                      // 0x0490(0x0010) MISSED OFFSET
	float                                              CurrentWindAngle;                                         // 0x04A0(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	float                                              CurrentWindMagnitude;                                     // 0x04A4(0x0004) (Net, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xE0];                                      // 0x04A8(0x00E0) MISSED OFFSET
	TArray<class UObject*>                             WindZones;                                                // 0x0588(0x0010) (Net, ZeroConstructor)
