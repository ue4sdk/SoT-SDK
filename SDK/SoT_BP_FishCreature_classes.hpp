...
public:
	...
	TArray<TAssetPtr<class UStaticMesh>>               Fish_04;                                                  // 0x04F8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<TAssetPtr<class UStaticMesh>>               Fish_05;                                                  // 0x0508(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	TArray<TAssetPtr<class UStaticMesh>>               Fish_07;                                                  // 0x0530(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	TArray<TAssetPtr<class UStaticMesh>>               Clown_01;                                                 // 0x0548(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	TArray<TAssetPtr<class UStaticMesh>>               Splashtail;                                               // 0x0560(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<TAssetPtr<class UStaticMesh>>               Pondie;                                                   // 0x0570(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	struct FLinearColor                                FishDistribution;                                         // 0x0580(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
