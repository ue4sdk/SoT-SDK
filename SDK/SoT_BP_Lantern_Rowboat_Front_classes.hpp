...
public:
	...
	TEnumAsByte<EFlameOfFateType>                      CurrentFlameOFateType;                                    // 0x0709(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x070A(0x0002) MISSED OFFSET
	struct FLinearColor                                DefaultGlowColour;                                        // 0x070C(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
