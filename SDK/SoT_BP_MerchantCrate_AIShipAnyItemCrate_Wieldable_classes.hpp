...
#include "SoT_BP_MerchantCrate_AIShipAnyItemCrate_Wieldable_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MerchantCrate_AIShipAnyItemCrate_Wieldable.BP_MerchantCrate_AIShipAnyItemCrate_Wieldable_C"));
		return ptr;
	}
