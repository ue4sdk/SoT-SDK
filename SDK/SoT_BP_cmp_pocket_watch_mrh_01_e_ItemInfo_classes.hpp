...
#include "SoT_BP_cmp_pocket_watch_mrh_01_e_ItemInfo_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_cmp_pocket_watch_mrh_01_e_ItemInfo.BP_cmp_pocket_watch_mrh_01_e_ItemInfo_C"));
		return ptr;
	}
