...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_wpn_flintlock_pistol_elb_01_a_v02_ItemInfo.BP_wpn_flintlock_pistol_elb_01_a_v02_ItemInfo_C");
		return ptr;
	}
