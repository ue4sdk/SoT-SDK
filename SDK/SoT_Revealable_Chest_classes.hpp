...
#include "SoT_Revealable_Chest_structs.hpp"
...
// AnimBlueprintGeneratedClass Revealable_Chest.Revealable_Chest_C
// 0x0391 (0x07D1 - 0x0440)
class URevealable_Chest_C : public UAnimInstance
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                           // 0x0440(0x0008) (ZeroConstructor, Transient, DuplicateTransient)
	struct FAnimNode_Root                              AnimGraphNode_Root_682D23CE4C781F5124AFDB9323E36997;      // 0x0448(0x0048)
	...
	struct FAnimNode_StateMachine                      AnimGraphNode_StateMachine_355FB13041EE7D9ADF6D348C0A6E2F8B;// 0x0728(0x00A8)
	bool                                               PlayAnimation;                                            // 0x07D0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass Revealable_Chest.Revealable_Chest_C"));
		return ptr;
	}


	void EvaluateGraphExposedInputs_ExecuteUbergraph_Revealable_Chest_AnimGraphNode_TransitionResult_8290739D47E8E65C0DCFE7BD011CF2FE();
	void SetIsPlayingAnim(bool IsPlaying);
	void ExecuteUbergraph_Revealable_Chest(int EntryPoint);
};
