...
public:
	...
	FObjectMessagingHandle                             Handle_EmissaryRankChange;                                // 0x0120(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	FName                                              ExpectedCompanyName;                                      // 0x0178(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	UClass*                                            PromptAccessKey;                                          // 0x0198(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	void OnEmissaryLevelRankChange(const FEmissaryLevel_FEmissaryLevelRankChange& NewParam);
	void EmissaryLevelRankChange(const FEmissaryLevel_FEmissaryLevelRankChange& NewParam);
	void Evaluate();
