...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_ResourceIslandWashedUpCargoRunsSpawner_DVR.BP_ResourceIslandWashedUpCargoRunsSpawner_DVR_C");
		return ptr;
	}
