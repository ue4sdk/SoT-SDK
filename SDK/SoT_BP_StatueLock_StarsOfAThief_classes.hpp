...
#include "SoT_BP_StatueLock_StarsOfAThief_structs.hpp"
...
// BlueprintGeneratedClass BP_StatueLock_StarsOfAThief.BP_StatueLock_StarsOfAThief_C
// 0x0040 (0x0508 - 0x04C8)
class ABP_StatueLock_StarsOfAThief_C : public AInteractableBase
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_StatueLock_StarsOfAThief.BP_StatueLock_StarsOfAThief_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_StatueLock_StarsOfAThief(int EntryPoint);
};
