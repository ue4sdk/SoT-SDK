...
{
public:
	class UExponentialHeightFogComponent*              ExponentialHeightFog;                                     // 0x0478(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USkyLightComponent*                          SkyLight;                                                 // 0x0480(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FScriptMulticastDelegate                    PreviewBusy;                                              // 0x04B0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)
	struct FScriptMulticastDelegate                    PreviewReady;                                             // 0x04C0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)
