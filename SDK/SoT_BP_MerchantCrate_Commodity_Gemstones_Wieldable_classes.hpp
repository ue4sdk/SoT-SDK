...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_MerchantCrate_Commodity_Gemstones_Wieldable.BP_MerchantCrate_Commodity_Gemstones_Wieldable_C");
		return ptr;
	}
