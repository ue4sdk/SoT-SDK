...
#include "SoT_BP_CursedRogue_LockedChest_structs.hpp"
...
// BlueprintGeneratedClass BP_CursedRogue_LockedChest.BP_CursedRogue_LockedChest_C
// 0x0040 (0x0500 - 0x04C0)
class ABP_CursedRogue_LockedChest_C : public AInteractableBase
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_CursedRogue_LockedChest.BP_CursedRogue_LockedChest_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_CursedRogue_LockedChest(int EntryPoint);
};
