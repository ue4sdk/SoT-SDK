...
#include "SoT_BP_SeapostShopkeeper_structs.hpp"
...
// BlueprintGeneratedClass BP_SeapostShopkeeper.BP_SeapostShopkeeper_C
// 0x0020 (0x0598 - 0x0578)
class ABP_SeapostShopkeeper_C : public AShopkeeper
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_SeapostShopkeeper.BP_SeapostShopkeeper_C");
		return ptr;
	}
