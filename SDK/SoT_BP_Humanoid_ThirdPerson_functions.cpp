...
// Parameters:
// UClass*                        CharacterType                  (Parm, ZeroConstructor, IsPlainOldData)

void UBP_Humanoid_ThirdPerson_C::SetInitialAthenaCharacterAndAnimSet(UClass* CharacterType)
{
...
void UBP_Humanoid_ThirdPerson_C::ParametricBlendFunction(int NoOfInputs, const FVector2D& FullRange, float InputValue, TArray<float>* OutputWeights)
{
...
void UBP_Humanoid_ThirdPerson_C::ItemWielded(const TScriptInterface<class UWieldableInterface>& Item, FWieldAnimationParams* AnimParams)
{
...
void UBP_Humanoid_ThirdPerson_C::Convert_Blendspace_1D_Structure_to_Array(int Index, TArray<FBP_BlendSpace1DVariants>* BlendSpace_Structure, TArray<UBlendSpace1D*>* BlendSpaceArray)
{
...
void UBP_Humanoid_ThirdPerson_C::Convert_Blendspace_Structure_To_Array(int Index, TArray<FBP_BlendSpaceVariants>* BlendSpace_Structure, TArray<UBlendSpace*>* BlendSpaceArray)
{
...
void UBP_Humanoid_ThirdPerson_C::FindFloorTilt(AAthenaCharacter* AthenaCharacter, float* Forward_FloorTilt, float* Lateral_Floor_Tilt)
{
...
void UBP_Humanoid_ThirdPerson_C::Receive_Animation_State(const FRotator& WheelRotation, float WheelAnimationTime, TEnumAsByte<EWheel> EWheel, float Direction, float WheelRate)
{
...
void UBP_Humanoid_ThirdPerson_C::Update_Athena_Character(AAthenaCharacter* AthenaCharacter)
{
...
void UBP_Humanoid_ThirdPerson_C::DockingInterface(const FBP_Docking& Docking)
{
...
void UBP_Humanoid_ThirdPerson_C::CapstanForce(float IndividualForce, const FTransform& LH_IK, const FTransform& RH_IK, AActor* Actor)
{
...
void UBP_Humanoid_ThirdPerson_C::UnbindFromCharacter(AAthenaCharacter* Character)
{
...
void UBP_Humanoid_ThirdPerson_C::BindThirdPersonToCharacter(AAthenaCharacter* Character, UClass* AnimDataId)
{
...
void UBP_Humanoid_ThirdPerson_C::LoadCharacterAnimations(UClass* AnimDataId)
{
...
void UBP_Humanoid_ThirdPerson_C::IK_Limb_Update_Transform(TEnumAsByte<EIKLimbName> LimbId, const FTransform& TransformUpdate)
{
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// FStartedUndockingFromControllableObjectEvent Event                          (Parm, ZeroConstructor, IsPlainOldData)

void UBP_Humanoid_ThirdPerson_C::OnStartedUndocking(const FStartedUndockingFromControllableObjectEvent& Event)
{
...
void UBP_Humanoid_ThirdPerson_C::OnTakenControl(const FEventTakenControlOfObject& TakenControlOfObjectEvent)
{
...
void UBP_Humanoid_ThirdPerson_C::OnRelinqusihedControl(const FEventRelinquishedControlOfObject& RelinquishedControlEvent)
{
...
void UBP_Humanoid_ThirdPerson_C::OnImpact(const FVector& ImpactLocation, const FVector& ImpactNormal, const FVector& ImpactVelocity, TEnumAsByte<ECharacterHitReactionAnimType> HitReactionAnimType)
{
