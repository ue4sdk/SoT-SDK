...
{
public:
	class UStaticMeshComponent*                        Sphere;                                                   // 0x0770(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USphereComponent*                            Collision;                                                // 0x0778(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
