...
{
	UClass*                                            InputID;                                                  // 0x0000(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	FText                                              Name;                                                     // 0x0008(0x0038) (Edit, DisableEditOnInstance)
};
...
{
	FTimespan                                          InactivityThreshold;                                      // 0x0000(0x0008) (Edit, ZeroConstructor)
...
{
	UCompositeInputHandler*                            InputHandler;                                             // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
	TArray<FPrioritizedCompositeInputHandler>          PrioritizedCompositeInputHandlers;                        // 0x0000(0x0010) (ZeroConstructor)
