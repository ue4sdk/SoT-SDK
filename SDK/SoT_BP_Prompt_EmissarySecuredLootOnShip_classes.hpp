...
public:
	...
	FObjectMessagingHandle                             Handle_EmissarySecuredLootOnShip;                         // 0x0120(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	void OnEmissarySecuredLootOnShip(const FEmissarySecuredLootOnShipNetworkEvent& NewParam);
	void EmissarySecuredLootOnShip(const FEmissarySecuredLootOnShipNetworkEvent& NewParam);
	void Evaluate();
