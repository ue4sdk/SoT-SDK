...
public:
	...
	UPointLightComponent*                              PointLight;                                               // 0x0440(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	UParticleSystemComponent*                          vfx_PortalAmbience_02;                                    // 0x0448(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	UParticleSystemComponent*                          vfx_PortalAmbience_01;                                    // 0x0450(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
