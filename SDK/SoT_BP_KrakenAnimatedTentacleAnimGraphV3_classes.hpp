...
public:
	...
	struct FAnimNode_Root                              AnimGraphNode_Root_347B3A8247B56C030097BDA1D1D1C13F;      // 0x0568(0x0048)
	struct FAnimNode_Slot                              AnimGraphNode_Slot_8A0FF8BC4F174EB679817397C9FBFF3F;      // 0x05B0(0x0060)
	struct FAnimNode_Slot                              AnimGraphNode_Slot_E09CF02F4AC57E91F5EB89A903831134;      // 0x0610(0x0060)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>("AnimBlueprintGeneratedClass BP_KrakenAnimatedTentacleAnimGraphV3.BP_KrakenAnimatedTentacleAnimGraphV3_C");
		return ptr;
	}
