...
public:
	...
	class UChildActorComponent*                        BP_ShipFlagCustomizationChest;                            // 0x0B30(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        CrowsNest;                                                // 0x0B38(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UChildActorComponent*                        BP_BellLower;                                             // 0x0B40(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        BellSupportLower;                                         // 0x0B48(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UStaticMeshComponent*                        shp_flag_pennant_alliance_01_a;                           // 0x0B60(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
