...
public:
	...
	class UChildActorComponent*                        BP_BellLower;                                             // 0x0AA0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        BellSupportLower;                                         // 0x0AA8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
