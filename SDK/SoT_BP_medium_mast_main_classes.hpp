...
public:
	...
	class UChildActorComponent*                        BP_BellLower;                                             // 0x0A50(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        BellSupportLower;                                         // 0x0A58(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
