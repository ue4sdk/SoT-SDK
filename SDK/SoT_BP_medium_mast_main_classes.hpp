...
public:
	...
	class UChildActorComponent*                        BP_ShipFlagCustomizationChest;                            // 0x0998(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        shp_crows_nest_01_a;                                      // 0x09A0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UChildActorComponent*                        BP_BellLower;                                             // 0x09A8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        BellSupportLower;                                         // 0x09B0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UStaticMeshComponent*                        shp_flag_pennant_alliance_01_a;                           // 0x09C8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
