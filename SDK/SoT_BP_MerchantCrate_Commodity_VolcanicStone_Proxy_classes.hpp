...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MerchantCrate_Commodity_VolcanicStone_Proxy.BP_MerchantCrate_Commodity_VolcanicStone_Proxy_C"));
		return ptr;
	}
