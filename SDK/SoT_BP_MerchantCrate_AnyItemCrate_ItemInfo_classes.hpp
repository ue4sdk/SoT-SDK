...
#include "SoT_BP_MerchantCrate_AnyItemCrate_ItemInfo_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MerchantCrate_AnyItemCrate_ItemInfo.BP_MerchantCrate_AnyItemCrate_ItemInfo_C"));
		return ptr;
	}
