...
{
public:
	class UChildActorComponent*                        cmn_candle_group_01;                                      // 0x03D0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        bld_tvn_bar_arches_xms_01_a;                              // 0x03D8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
