...
public:
	...
	FObjectMessagingHandle                             Handle_OnShipDamaged;                                     // 0x0128(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	void OnShipDamaged(const FDamageZoneDamageLevelChanged& Event);
