...
public:
	...
	FStringAssetReference                              PlaceholderSpinnerTexture;                                // 0x0040(0x0010) (Edit, ZeroConstructor)
	FLinearColor                                       BackgroundColour;                                         // 0x0050(0x0010) (Edit, ZeroConstructor, IsPlainOldData)
	FSlateLoadingScreenImageParams                     PrimaryImage;                                             // 0x0060(0x0020) (Edit)
	TArray<FSlateLoadingScreenImageParams>             CyclingImages;                                            // 0x0080(0x0010) (Edit, ZeroConstructor)
	int                                                MaxNumImagesPerLoad;                                      // 0x0090(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0094(0x0004) MISSED OFFSET
	FText                                              SpinnerText;                                              // 0x0098(0x0038) (Edit)
	FSlateColor                                        SpinnerTextColour;                                        // 0x00D0(0x0030) (Edit)
	FSlateFontInfo                                     SpinnerTextFont;                                          // 0x0100(0x0040) (Edit)
	float                                              SpinnerSize;                                              // 0x0140(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	FMargin                                            SpinnerMargin;                                            // 0x0144(0x0010) (Edit)
	float                                              SpinnerPadding;                                           // 0x0154(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	FStringAssetReference                              SpinnerIcon;                                              // 0x0158(0x0010) (Edit, ZeroConstructor)
	FMargin                                            TipsMargin;                                               // 0x0168(0x0010) (Edit)
	...
	FSlateFontInfo                                     LoadingTipFont;                                           // 0x0188(0x0040) (Edit)
	...
	TArray<FText>                                      LoadingScreenTips;                                        // 0x01D0(0x0010) (Edit, ZeroConstructor)
	FSlateColor                                        LoadingScreenTipColour;                                   // 0x01E0(0x0030) (Edit)
...
{
public:
	FStringAssetReference                              BootLoadingScreen;                                        // 0x0038(0x0010) (Edit, ZeroConstructor, Config)
	FStringAssetReference                              TeleportLoadingScreen;                                    // 0x0048(0x0010) (Edit, ZeroConstructor, Config)
	FStringAssetReference                              AdventureLoadingScreens;                                  // 0x0058(0x0010) (Edit, ZeroConstructor, Config)
	FStringAssetReference                              ArenaLoadingScreens;                                      // 0x0068(0x0010) (Edit, ZeroConstructor, Config)
...
public:
	...
	static bool IsStreaming(UObject* WorldContextObject);
};
