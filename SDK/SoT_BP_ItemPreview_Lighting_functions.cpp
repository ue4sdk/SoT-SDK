...
void ABP_ItemPreview_Lighting_C::PreviewReady__DelegateSignature(const FPiratePreviewReadyEvent& Data)
{
...
void ABP_ItemPreview_Lighting_C::PreviewBusy__DelegateSignature(const FPiratePreviewBusyEvent& Data)
{
