...
public:
	...
	class UStaticMeshComponent*                        LightsProxy;                                              // 0x0508(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_AILargeShipNetProxy.BP_AILargeShipNetProxy_C");
		return ptr;
	}
