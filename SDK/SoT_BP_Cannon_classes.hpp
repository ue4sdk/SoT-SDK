...
public:
	...
	class UGroupedInteractableAreaComponent*           GroupedInteractableArea;                                  // 0x0BA0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UInteractableComponent*                      Interactable;                                             // 0x0BA8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        Collision;                                                // 0x0BB0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
