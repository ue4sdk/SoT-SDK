...
public:
	...
	class UGroupedInteractableAreaComponent*           GroupedInteractableArea;                                  // 0x0B80(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UInteractableComponent*                      Interactable;                                             // 0x0B88(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        Collision;                                                // 0x0B90(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
