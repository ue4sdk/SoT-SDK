...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Campaign005_CursedSails_OOS_MadameOlivia_CursedSails.BP_Campaign005_CursedSails_OOS_MadameOlivia_CursedSails_C");
		return ptr;
	}
