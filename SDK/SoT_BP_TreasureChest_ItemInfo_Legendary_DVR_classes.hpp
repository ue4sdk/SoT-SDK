...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_TreasureChest_ItemInfo_Legendary_DVR.BP_TreasureChest_ItemInfo_Legendary_DVR_C"));
		return ptr;
	}
