...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MerchantCrate_Commodity_Ore_Wieldable.BP_MerchantCrate_Commodity_Ore_Wieldable_C"));
		return ptr;
	}
