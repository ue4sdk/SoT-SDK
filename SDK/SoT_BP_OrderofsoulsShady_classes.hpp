...
#include "SoT_BP_OrderofsoulsShady_structs.hpp"
...
// BlueprintGeneratedClass BP_OrderofsoulsShady.BP_OrderofsoulsShady_C
// 0x0018 (0x05B0 - 0x0598)
class ABP_OrderofsoulsShady_C : public ACompanyShopkeeper
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_OrderofsoulsShady.BP_OrderofsoulsShady_C"));
		return ptr;
	}
