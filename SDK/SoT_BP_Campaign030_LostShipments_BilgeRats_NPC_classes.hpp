...
#include "SoT_BP_Campaign030_LostShipments_BilgeRats_NPC_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Campaign030_LostShipments_BilgeRats_NPC.BP_Campaign030_LostShipments_BilgeRats_NPC_C"));
		return ptr;
	}
