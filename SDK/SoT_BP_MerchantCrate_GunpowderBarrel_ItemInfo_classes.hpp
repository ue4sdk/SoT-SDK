...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MerchantCrate_GunpowderBarrel_ItemInfo.BP_MerchantCrate_GunpowderBarrel_ItemInfo_C"));
		return ptr;
	}
