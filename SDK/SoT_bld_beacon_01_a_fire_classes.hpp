...
public:
	...
	class UParticleSystemComponent*                    vfx_fire_beacon;                                          // 0x04B0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass bld_beacon_01_a_fire.bld_beacon_01_a_fire_C");
		return ptr;
	}
