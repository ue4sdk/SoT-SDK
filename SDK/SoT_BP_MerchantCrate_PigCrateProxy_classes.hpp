...
{
public:
	class UFeedingComponent*                           Feeding;                                                  // 0x0870(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMountpointComponent*                        Mountpoint;                                               // 0x0878(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
