...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_ResourceIslandWashedUpMerchantCratesSpawner.BP_ResourceIslandWashedUpMerchantCratesSpawner_C");
		return ptr;
	}
