...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_ResourceIslandWashedUpMerchantCratesSpawner.BP_ResourceIslandWashedUpMerchantCratesSpawner_C");
		return ptr;
	}
