...
#include "SoT_BP_VotableTaleProposal_TheAshenDragon_structs.hpp"
...
// BlueprintGeneratedClass BP_VotableTaleProposal_TheAshenDragon.BP_VotableTaleProposal_TheAshenDragon_C
// 0x0050 (0x0570 - 0x0520)
class ABP_VotableTaleProposal_TheAshenDragon_C : public AVotableObjectView
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_VotableTaleProposal_TheAshenDragon.BP_VotableTaleProposal_TheAshenDragon_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_VotableTaleProposal_TheAshenDragon(int EntryPoint);
};
