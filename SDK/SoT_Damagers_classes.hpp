...
public:
	...
	UClass*                                            DamagerType;                                              // 0x00E0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	...
	FVector                                            LocalOffset;                                              // 0x00EC(0x000C) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	void StartShockwaveAtLocation(const FVector& StartLocation);
	void StartShockwave();
	void IgnoreGhostShip(AAggressiveGhostShip* Ship);
...
public:
	...
	FWeightedProbabilityRangeOfRanges                  ForceToApplyToShip;                                       // 0x00E0(0x0030) (Edit, DisableEditOnInstance)
	...
	TArray<FShockwaveDamagerShipDamage>                ShipDamageLevels;                                         // 0x0118(0x0010) (Edit, ZeroConstructor, DisableEditOnInstance)
	UClass*                                            DamagerType;                                              // 0x0128(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	FScriptMulticastDelegate                           OnShockwaveStarted;                                       // 0x0148(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	FScriptMulticastDelegate                           OnShockwaveEnded;                                         // 0x0158(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	...
	void Multi_StartShockwave(const FVector& InStartLocation);
};
...
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x00C8(0x0008) MISSED OFFSET
	UPrimitiveComponent*                               Shape;                                                    // 0x00D0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	FStrainDamage                                      ShipStrainDamage;                                         // 0x00F8(0x0028) (Edit)
	FWeightedProbabilityRangeOfRanges                  TimeBetweenWatercraftDamage;                              // 0x0120(0x0030) (Edit)
	...
	void SetShape(UPrimitiveComponent* InShape);
	void EndDamage();
	void BeginDamage();
};
