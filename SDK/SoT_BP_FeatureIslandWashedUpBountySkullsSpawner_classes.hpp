...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_FeatureIslandWashedUpBountySkullsSpawner.BP_FeatureIslandWashedUpBountySkullsSpawner_C");
		return ptr;
	}
