...
#include "SoT_BP_SkeletonFortStorageBarrel_DVR_structs.hpp"
...
// BlueprintGeneratedClass BP_SkeletonFortStorageBarrel_DVR.BP_SkeletonFortStorageBarrel_DVR_C
// 0x0018 (0x0538 - 0x0520)
class ABP_SkeletonFortStorageBarrel_DVR_C : public AStorageContainer
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_SkeletonFortStorageBarrel_DVR.BP_SkeletonFortStorageBarrel_DVR_C"));
		return ptr;
	}
