...
{
public:
	class UChildActorComponent*                        Arm1;                                                     // 0x0870(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UChildActorComponent*                        Arm4;                                                     // 0x0878(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UChildActorComponent*                        Arm3;                                                     // 0x0880(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
