...
#include "SoT_Revealable_AveragePirateV3_AnimInstance_structs.hpp"
...
// AnimBlueprintGeneratedClass Revealable_AveragePirateV3_AnimInstance.Revealable_AveragePirateV3_AnimInstance_C
// 0x0391 (0x07D1 - 0x0440)
class URevealable_AveragePirateV3_AnimInstance_C : public UAnimInstance
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                           // 0x0440(0x0008) (ZeroConstructor, Transient, DuplicateTransient)
	struct FAnimNode_Root                              AnimGraphNode_Root_4193C9574AE6363C1BF6B288777DD908;      // 0x0448(0x0048)
	...
	struct FAnimNode_StateMachine                      AnimGraphNode_StateMachine_F69528C5479E4AA60C2B32BFC34659F0;// 0x0728(0x00A8)
	bool                                               PlayAnimation;                                            // 0x07D0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass Revealable_AveragePirateV3_AnimInstance.Revealable_AveragePirateV3_AnimInstance_C"));
		return ptr;
	}


	void EvaluateGraphExposedInputs_ExecuteUbergraph_Revealable_AveragePirateV3_AnimInstance_AnimGraphNode_TransitionResult_8290739D47E8E65C0DCFE7BD011CF2FE();
	void SetIsPlayingAnim(bool IsPlaying);
	void ExecuteUbergraph_Revealable_AveragePirateV3_AnimInstance(int EntryPoint);
};
