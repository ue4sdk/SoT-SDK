...
struct FSocketPath
{
	TArray<FSocketPathNode>                            Nodes;                                                    // 0x0000(0x0010) (Edit, ZeroConstructor)
...
struct FSocketId
{
	FSocketPath                                        path;                                                     // 0x0000(0x0018) (Edit, BlueprintVisible)
	FName                                              Name;                                                     // 0x0018(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
