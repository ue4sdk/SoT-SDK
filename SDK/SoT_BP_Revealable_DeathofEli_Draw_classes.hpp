...
#include "SoT_BP_Revealable_DeathofEli_Draw_structs.hpp"
...
// BlueprintGeneratedClass BP_Revealable_DeathofEli_Draw.BP_Revealable_DeathofEli_Draw_C
// 0x0038 (0x0508 - 0x04D0)
class ABP_Revealable_DeathofEli_Draw_C : public ABP_Revealable_BaseMesh_C
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Revealable_DeathofEli_Draw.BP_Revealable_DeathofEli_Draw_C"));
		return ptr;
	}
