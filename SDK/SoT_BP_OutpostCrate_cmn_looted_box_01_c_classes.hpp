...
#include "SoT_BP_OutpostCrate_cmn_looted_box_01_c_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_OutpostCrate_cmn_looted_box_01_c.BP_OutpostCrate_cmn_looted_box_01_c_C"));
		return ptr;
	}
