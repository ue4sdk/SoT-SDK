...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Campaign005_CursedSails_ClothingCarl_PreCursedSails.BP_Campaign005_CursedSails_ClothingCarl_PreCursedSails_C");
		return ptr;
	}
