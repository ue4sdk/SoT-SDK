...
#include "SoT_BP_SkeletonFortStorageBarrel_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_SkeletonFortStorageBarrel.BP_SkeletonFortStorageBarrel_C"));
		return ptr;
	}
