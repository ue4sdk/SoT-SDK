...
public:
	...
	class UCursedSailsCampaignDataAsset*               CampaignParams;                                           // 0x0488(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x58];                                      // 0x0490(0x0058) MISSED OFFSET
