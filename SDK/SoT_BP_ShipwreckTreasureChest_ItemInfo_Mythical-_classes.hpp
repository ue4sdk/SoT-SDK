...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ShipwreckTreasureChest_ItemInfo_Mythical-.BP_ShipwreckTreasureChest_ItemInfo_Mythical-_C"));
		return ptr;
	}
