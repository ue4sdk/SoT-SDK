...
{
public:
	class UGlintComponent*                             Glint;                                                    // 0x0868(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UParticleSystemComponent*                    ParticleSystem;                                           // 0x0870(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
