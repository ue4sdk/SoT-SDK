...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_wpn_sniper_rifle_wth_01_a_v01_ItemDesc.BP_wpn_sniper_rifle_wth_01_a_v01_ItemDesc_C");
		return ptr;
	}
