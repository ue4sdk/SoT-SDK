...
public:
	...
	class URotateMeshToLocalPlayerComponent*           RotateMeshToLocalPlayer;                                  // 0x0490(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        FarCloudDistortion;                                       // 0x0498(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        Shroud;                                                   // 0x04A0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FadeIn_GhostBloom_8A3F310E4DA80126C74D32B4D69B71D3;       // 0x04A8(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              FadeIn_GhostOpacity_8A3F310E4DA80126C74D32B4D69B71D3;     // 0x04AC(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETimelineDirection>                    FadeIn__Direction_8A3F310E4DA80126C74D32B4D69B71D3;       // 0x04B0(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	TArray<class UMaterialInstanceDynamic*>            DynamicMaterials;                                         // 0x04C0(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
