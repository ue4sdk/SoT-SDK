...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_MerchantCrate_Commodity_Gemstones_ItemInfo.BP_MerchantCrate_Commodity_Gemstones_ItemInfo_C");
		return ptr;
	}
