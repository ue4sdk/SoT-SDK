...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_PigAIController.BP_PigAIController_C.UserConstructionScript"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_PigAIController.BP_PigAIController_C.ReceiveBeginPlay"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_PigAIController.BP_PigAIController_C.ExecuteUbergraph_BP_PigAIController"));
