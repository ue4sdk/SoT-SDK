...
public:
	...
	FObjectMessagingHandle                             Handle_EmissaryDiscoveredLoot;                            // 0x0120(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)
	FName                                              CompnayName;                                              // 0x0168(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	void OnEmissaryDiscoveredLoot(const FEmissaryDiscoveredLootNetworkEvent& NewParam);
	void EmissaryDiscoveredLoot(const FEmissaryDiscoveredLootNetworkEvent& NewParam);
	void Evaluate();
