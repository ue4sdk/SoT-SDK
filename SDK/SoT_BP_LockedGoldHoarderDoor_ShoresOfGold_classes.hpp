...
#include "SoT_BP_LockedGoldHoarderDoor_ShoresOfGold_structs.hpp"
...
// BlueprintGeneratedClass BP_LockedGoldHoarderDoor_ShoresOfGold.BP_LockedGoldHoarderDoor_ShoresOfGold_C
// 0x0038 (0x0500 - 0x04C8)
class ABP_LockedGoldHoarderDoor_ShoresOfGold_C : public AInteractableBase
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_LockedGoldHoarderDoor_ShoresOfGold.BP_LockedGoldHoarderDoor_ShoresOfGold_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_LockedGoldHoarderDoor_ShoresOfGold(int EntryPoint);
};
