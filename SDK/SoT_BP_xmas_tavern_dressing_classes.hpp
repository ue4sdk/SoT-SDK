...
public:
	...
	class UChildActorComponent*                        cmn_candle_group_02;                                      // 0x04B8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UChildActorComponent*                        cmn_candle_group_01;                                      // 0x04C0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        bld_tvn_bar_arches_xms_01_a;                              // 0x04C8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
