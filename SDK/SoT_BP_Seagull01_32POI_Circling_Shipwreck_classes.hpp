...
{
public:
	class UWwiseEmitterComponent*                      WwiseEmitter2;                                            // 0x04A0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UStaticMeshComponent*                        wil_seagull_01_ProcAnim32;                                // 0x04B8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
