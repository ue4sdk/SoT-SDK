...
public:
	...
	class USceneComponent*                             LockSocketsRoot;                                          // 0x0860(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class ULockComponent*                              Lock;                                                     // 0x0868(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
