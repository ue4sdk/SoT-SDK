...
public:
	...
	class USceneComponent*                             LockSocketsRoot;                                          // 0x0878(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class ULockComponent*                              Lock;                                                     // 0x0880(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
