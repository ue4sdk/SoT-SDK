...
public:
	...
	FObjectMessagingHandle                             Handle_OnWheelDamaged;                                    // 0x0128(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	void OnShipDamaged(const FEventWheelDamageLevelChanged& Event);
