...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass hulllivery_underwater_01_CustomizationDesc.hulllivery_underwater_01_CustomizationDesc_C"));
		return ptr;
	}
