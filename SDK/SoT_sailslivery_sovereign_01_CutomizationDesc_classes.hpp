...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass sailslivery_sovereign_01_CutomizationDesc.sailslivery_sovereign_01_CutomizationDesc_C");
		return ptr;
	}
