...
#include "SoT_BP_Phantom_AudioComponent_structs.hpp"
...
// BlueprintGeneratedClass BP_Phantom_AudioComponent.BP_Phantom_AudioComponent_C
// 0x0058 (0x0388 - 0x0330)
class UBP_Phantom_AudioComponent_C : public USkeletonAICharacterAudioComponent
{
public:
	...
	FObjectMessagingHandle                             Dispatcher_handle;                                        // 0x0340(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Phantom_AudioComponent.BP_Phantom_AudioComponent_C"));
		return ptr;
	}
