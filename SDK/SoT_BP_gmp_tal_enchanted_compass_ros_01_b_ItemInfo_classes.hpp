...
#include "SoT_BP_gmp_tal_enchanted_compass_ros_01_b_ItemInfo_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_gmp_tal_enchanted_compass_ros_01_b_ItemInfo.BP_gmp_tal_enchanted_compass_ros_01_b_ItemInfo_C"));
		return ptr;
	}
