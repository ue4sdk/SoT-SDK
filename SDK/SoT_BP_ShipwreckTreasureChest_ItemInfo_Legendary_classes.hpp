...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_ShipwreckTreasureChest_ItemInfo_Legendary.BP_ShipwreckTreasureChest_ItemInfo_Legendary_C"));
		return ptr;
	}
