...
{
	UObject*                                           FoliageTypeObject;                                        // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	UFoliageType_InstancedStaticMesh*                  TypeInstance;                                             // 0x0008(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	bool                                               bIsAsset;                                                 // 0x0010(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0011(0x0007) MISSED OFFSET
	UClass*                                            Type;                                                     // 0x0018(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
};
...
struct FProceduralFoliageInstance
{
	...
	FVector                                            Normal;                                                   // 0x0020(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	UFoliageType_InstancedStaticMesh*                  Type;                                                     // 0x0038(0x0008) (ZeroConstructor, IsPlainOldData)
