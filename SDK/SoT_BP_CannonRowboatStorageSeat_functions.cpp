...
#include "SoT_BP_CannonRowboatStorageSeat_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_CannonRowboatStorageSeat.BP_CannonRowboatStorageSeat_C.UserConstructionScript"));
