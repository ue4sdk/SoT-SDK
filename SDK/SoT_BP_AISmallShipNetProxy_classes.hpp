...
public:
	...
	class UStaticMeshComponent*                        LightProxy;                                               // 0x0528(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<class UMaterialInstanceDynamic*>            Dynamic_Materials;                                        // 0x0530(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
