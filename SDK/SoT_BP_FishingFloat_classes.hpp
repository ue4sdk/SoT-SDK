...
{
public:
	class UBoxComponent*                               WaterInteractionOverlap;                                  // 0x0A30(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        StaticMesh;                                               // 0x0A38(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
