...
public:
	...
	TEnumAsByte<EFlameOfFateType>                      CurrentFlameOfFateType;                                   // 0x0820(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
