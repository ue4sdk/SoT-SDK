...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_MerchantCrate_Commodity_Minerals_Wieldable.BP_MerchantCrate_Commodity_Minerals_Wieldable_C");
		return ptr;
	}
