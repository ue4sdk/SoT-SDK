...
#include "SoT_BP_SaltyHandIn_structs.hpp"
...
// BlueprintGeneratedClass BP_SaltyHandIn.BP_SaltyHandIn_C
// 0x0038 (0x04F8 - 0x04C0)
class ABP_SaltyHandIn_C : public AInteractableBase
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_SaltyHandIn.BP_SaltyHandIn_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_SaltyHandIn(int EntryPoint);
};
