...
public:
	...
	class UCargoRunParticipantComponent*               CargoRunParticipant;                                      // 0x05C0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UWwiseEvent*                                 SFX_IdleLoopPlay;                                         // 0x05E8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UWwiseEvent*                                 SFX_IdleLoopStop;                                         // 0x05F0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FWwiseEmitter                               InnkeeperEmitter;                                         // 0x05F8(0x0020) (Edit, BlueprintVisible, DisableEditOnInstance)
