...
public:
	...
	class UWwiseEvent*                                 SFX_IdleLoopPlay;                                         // 0x0560(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UWwiseEvent*                                 SFX_IdleLoopStop;                                         // 0x0568(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FWwiseEmitter                               InnkeeperEmitter;                                         // 0x0570(0x0020) (Edit, BlueprintVisible, DisableEditOnInstance)
