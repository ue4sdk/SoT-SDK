...
#include "SoT_BP_SirenTrident_ItemInfo_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_SirenTrident_ItemInfo.BP_SirenTrident_ItemInfo_C"));
		return ptr;
	}
