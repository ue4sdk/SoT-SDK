...
public:
	...
	TArray<class UMaterialInstanceDynamic*>            CordMaterials;                                            // 0x05E8(0x0010) (ZeroConstructor, Transient)
	float                                              ThicknessCm;                                              // 0x05F8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x24];                                      // 0x05FC(0x0024) MISSED OFFSET
...
{
public:
	class USceneComponent*                             EndPointA;                                                // 0x0620(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	class USceneComponent*                             EndPointB;                                                // 0x0628(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData00[0x50];                                      // 0x0630(0x0050) MISSED OFFSET
...
public:
	...
	float                                              LaunchAnimationDurationSecs;                              // 0x0628(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              HitAnimationDurationSecs;                                 // 0x062C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              QuickRetractAnimationSpeed;                               // 0x0630(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
