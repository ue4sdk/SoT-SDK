...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_TreasureChest_ItemInfo_PirateLegend_DVR.BP_TreasureChest_ItemInfo_PirateLegend_DVR_C");
		return ptr;
	}
