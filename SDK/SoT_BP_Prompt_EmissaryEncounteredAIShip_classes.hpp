...
public:
	...
	FObjectMessagingHandle                             Handle_EmissaryEncounteredAIShip;                         // 0x0120(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	void OnEmissaryEncounteredAIShip(const FEmissaryEncounteredAIShipEvent& NewParam);
	void EmissaryEncounteredAIShip(const FEmissaryEncounteredAIShipEvent& NewParam);
	void Evaluate();
