...
#include "SoT_BP_AI_wpn_unarmedCombat_ItemInfo_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_AI_wpn_unarmedCombat_ItemInfo.BP_AI_wpn_unarmedCombat_ItemInfo_C"));
		return ptr;
	}
