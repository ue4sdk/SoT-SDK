...
{
	UClass*                                            PromptActorClass;                                         // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	UClass*                                            AccessKey;                                                // 0x0008(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	FName                                              FeatureName;                                              // 0x0010(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
{
	FString                                            SequenceName;                                             // 0x0000(0x0010) (ZeroConstructor)
	FString                                            StepName;                                                 // 0x0010(0x0010) (ZeroConstructor)
