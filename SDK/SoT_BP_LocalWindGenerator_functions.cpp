...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_LocalWindGenerator.BP_LocalWindGenerator_C.StopReaction"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_LocalWindGenerator.BP_LocalWindGenerator_C.ApplyDisturbanceAtCurrentTime"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_LocalWindGenerator.BP_LocalWindGenerator_C.StartReaction"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_LocalWindGenerator.BP_LocalWindGenerator_C.UserConstructionScript"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_LocalWindGenerator.BP_LocalWindGenerator_C.ReceiveTick"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_LocalWindGenerator.BP_LocalWindGenerator_C.ExecuteUbergraph_BP_LocalWindGenerator"));
