...
{
public:
	class UStaticMeshComponent*                        Sphere;                                                   // 0x0780(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USphereComponent*                            Collision;                                                // 0x0788(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
