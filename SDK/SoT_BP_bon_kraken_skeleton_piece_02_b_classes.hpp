...
#include "SoT_BP_bon_kraken_skeleton_piece_02_b_structs.hpp"
...
// BlueprintGeneratedClass BP_bon_kraken_skeleton_piece_02_b.BP_bon_kraken_skeleton_piece_02_b_C
// 0x0070 (0x0520 - 0x04B0)
class ABP_bon_kraken_skeleton_piece_02_b_C : public AActor
{
public:
	class UStaticMeshComponent*                        StaticMeshComponent012;                                   // 0x04B0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        StaticMeshComponent011;                                   // 0x04B8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        StaticMeshComponent010;                                   // 0x04C0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_bon_kraken_skeleton_piece_02_b.BP_bon_kraken_skeleton_piece_02_b_C"));
		return ptr;
	}
