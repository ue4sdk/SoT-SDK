...
void UAthenaCheatManager::SpawnTinySharkAtCurrentLocation(int ControllerParamIndex)
{
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaCheat.AthenaCheatManager.SpawnKraken");
