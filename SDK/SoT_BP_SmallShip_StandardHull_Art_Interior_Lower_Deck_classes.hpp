...
{
public:
	class UStaticMeshComponent*                        shp_small_brig_01_a;                                      // 0x0480(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        shp_small_lower_deck_rope_01_a;                           // 0x0488(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        shp_small_lower_deck_01_a;                                // 0x0490(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
