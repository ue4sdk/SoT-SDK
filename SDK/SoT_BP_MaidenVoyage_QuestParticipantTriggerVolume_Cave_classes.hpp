...
#include "SoT_BP_MaidenVoyage_QuestParticipantTriggerVolume_Cave_structs.hpp"
...
// BlueprintGeneratedClass BP_MaidenVoyage_QuestParticipantTriggerVolume_Cave.BP_MaidenVoyage_QuestParticipantTriggerVolume_Cave_C
// 0x0030 (0x04A0 - 0x0470)
class ABP_MaidenVoyage_QuestParticipantTriggerVolume_Cave_C : public ATriggerBox
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MaidenVoyage_QuestParticipantTriggerVolume_Cave.BP_MaidenVoyage_QuestParticipantTriggerVolume_Cave_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_MaidenVoyage_QuestParticipantTriggerVolume_Cave(int EntryPoint);
