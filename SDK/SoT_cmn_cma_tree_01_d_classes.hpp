...
{
public:
	class UAudioEventToComponentMapComponent*          AudioEventToComponentMap;                                 // 0x04B8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UStaticMeshComponent*                        wsp_trunk_01_a;                                           // 0x04C8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
