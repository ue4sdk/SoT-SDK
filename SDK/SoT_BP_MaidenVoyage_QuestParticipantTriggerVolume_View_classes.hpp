...
#include "SoT_BP_MaidenVoyage_QuestParticipantTriggerVolume_View_structs.hpp"
...
// BlueprintGeneratedClass BP_MaidenVoyage_QuestParticipantTriggerVolume_View.BP_MaidenVoyage_QuestParticipantTriggerVolume_View_C
// 0x0030 (0x04A0 - 0x0470)
class ABP_MaidenVoyage_QuestParticipantTriggerVolume_View_C : public ATriggerBox
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MaidenVoyage_QuestParticipantTriggerVolume_View.BP_MaidenVoyage_QuestParticipantTriggerVolume_View_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_MaidenVoyage_QuestParticipantTriggerVolume_View(int EntryPoint);
