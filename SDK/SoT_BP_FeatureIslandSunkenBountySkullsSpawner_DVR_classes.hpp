...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_FeatureIslandSunkenBountySkullsSpawner_DVR.BP_FeatureIslandSunkenBountySkullsSpawner_DVR_C");
		return ptr;
	}
