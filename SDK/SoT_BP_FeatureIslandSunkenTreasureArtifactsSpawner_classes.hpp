...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_FeatureIslandSunkenTreasureArtifactsSpawner.BP_FeatureIslandSunkenTreasureArtifactsSpawner_C");
		return ptr;
	}
