...
public:
	...
	FObjectMessagingHandle                             Handle_EmissarySoldLoot;                                  // 0x0120(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	void OnEmissarySoldLoot(const FEmissarySoldLootNetworkEvent& NewParam);
	void EmissarySoldLoot(const FEmissarySoldLootNetworkEvent& NewParam);
	void Evaluate();
