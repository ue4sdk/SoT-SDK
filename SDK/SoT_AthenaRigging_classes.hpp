...
public:
	...
	TArray<class UMobileInstancedStaticMeshComponent*> PulleyInstances;                                          // 0x04A8(0x0010) (ExportObject, ZeroConstructor)
	struct FRiggingSystemPulleyData                    Pulleys;                                                  // 0x04B8(0x0060)
