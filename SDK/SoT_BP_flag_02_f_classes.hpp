...
{
public:
	class UStaticMeshComponent*                        bld_flag_post_02_flag_f;                                  // 0x0480(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        bld_flag_post_02_b;                                       // 0x0488(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
