...
class UBP_Component_Tutorial2019_C : public UTutorial2019Component
{
public:
	...
	struct FObjectMessagingHandle                      Handle_PlayerControllerShuttingDown;                      // 0x0178(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)
