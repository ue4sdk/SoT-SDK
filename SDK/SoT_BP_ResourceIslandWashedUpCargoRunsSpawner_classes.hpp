...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_ResourceIslandWashedUpCargoRunsSpawner.BP_ResourceIslandWashedUpCargoRunsSpawner_C");
		return ptr;
	}
