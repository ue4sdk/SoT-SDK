...
#include "SoT_BP_PromoItemShady_structs.hpp"
...
class ABP_PromoItemShady_C : public AShopkeeper
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_PromoItemShady.BP_PromoItemShady_C"));
		return ptr;
	}
