...
public:
	...
	TWeakObjectPtr<class AAthenaFFTWater>              FFTWaterActor;                                            // 0x04B8(0x0008) (Net, ZeroConstructor, IsPlainOldData)
	TWeakObjectPtr<class UFFTWaterComponent>           FFTWaterComponent;                                        // 0x04C0(0x0008) (ExportObject, Net, ZeroConstructor, InstancedReference, IsPlainOldData)
	TWeakObjectPtr<class UFFTWaterExtendedPlaneComponent> ExtendedPlaneComponent;                                   // 0x04C8(0x0008) (ExportObject, Net, ZeroConstructor, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0x50];                                      // 0x04D0(0x0050) MISSED OFFSET
	double                                             ReplicatedServerCreationTime;                             // 0x0520(0x0008) (Net, ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FFFTWaterPerformanceCountData               PerformanceCountData;                                     // 0x0528(0x0008)
...
{
public:
	float                                              RequiredWaterHeight;                                      // 0x0528(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	class USceneComponent*                             SceneRootComponent;                                       // 0x04A8(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBaseWaterComponent*                         BaseWaterComponent;                                       // 0x04B0(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
