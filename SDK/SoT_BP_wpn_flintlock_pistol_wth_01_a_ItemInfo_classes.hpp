...
#include "SoT_BP_wpn_flintlock_pistol_wth_01_a_ItemInfo_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_wpn_flintlock_pistol_wth_01_a_ItemInfo.BP_wpn_flintlock_pistol_wth_01_a_ItemInfo_C"));
		return ptr;
	}
