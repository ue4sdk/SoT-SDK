...
#include "SoT_BP_Rowboat_WithFrontCannon_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_Rowboat_WithFrontCannon.BP_Rowboat_WithFrontCannon_C.UserConstructionScript"));
