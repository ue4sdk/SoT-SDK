...
public:
	...
	class UBP_Prompt_EmissaryActivated_C*              PromptCoordinatorEmissaryActivated;                       // 0x0468(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	class UClass*                                      Company;                                                  // 0x0488(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
