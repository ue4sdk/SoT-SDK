...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_TreasureChest_Wieldable_Weeping.BP_TreasureChest_Wieldable_Weeping_C.UserConstructionScript"));
