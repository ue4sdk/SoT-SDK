...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_ShipwrightShady.BP_ShipwrightShady_C.UserConstructionScript"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_ShipwrightShady.BP_ShipwrightShady_C.ReceiveBeginPlay"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_ShipwrightShady.BP_ShipwrightShady_C.ReceiveEndPlay"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_ShipwrightShady.BP_ShipwrightShady_C.ExecuteUbergraph_BP_ShipwrightShady"));
