...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_Campaign005_CursedSails_ClothingColin_PreCursedSails.BP_Campaign005_CursedSails_ClothingColin_PreCursedSails_C");
		return ptr;
	}
