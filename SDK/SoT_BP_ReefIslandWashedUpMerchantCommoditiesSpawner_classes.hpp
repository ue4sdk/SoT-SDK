...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_ReefIslandWashedUpMerchantCommoditiesSpawner.BP_ReefIslandWashedUpMerchantCommoditiesSpawner_C");
		return ptr;
	}
