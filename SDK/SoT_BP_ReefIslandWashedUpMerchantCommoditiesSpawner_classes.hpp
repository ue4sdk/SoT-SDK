...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_ReefIslandWashedUpMerchantCommoditiesSpawner.BP_ReefIslandWashedUpMerchantCommoditiesSpawner_C");
		return ptr;
	}
