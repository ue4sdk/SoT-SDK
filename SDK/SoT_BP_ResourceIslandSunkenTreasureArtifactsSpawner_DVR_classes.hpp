...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_ResourceIslandSunkenTreasureArtifactsSpawner_DVR.BP_ResourceIslandSunkenTreasureArtifactsSpawner_DVR_C");
		return ptr;
	}
