...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_ResourceIslandSunkenTreasureArtifactsSpawner_DVR.BP_ResourceIslandSunkenTreasureArtifactsSpawner_DVR_C");
		return ptr;
	}
