...
public:
	...
	float                                              Ladder_Roll;                                              // 0x06E8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Ladder_Top_Target;                                        // 0x06EC(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Ladder_Bottom_Target;                                     // 0x06F8(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
