...
public:
	...
	float                                              Ladder_Roll;                                              // 0x06E0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Ladder_Top_Target;                                        // 0x06E4(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Ladder_Bottom_Target;                                     // 0x06F0(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
