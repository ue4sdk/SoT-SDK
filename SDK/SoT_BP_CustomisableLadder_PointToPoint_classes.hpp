...
public:
	...
	float                                              Ladder_Roll;                                              // 0x06A0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Ladder_Top_Target;                                        // 0x06A4(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Ladder_Bottom_Target;                                     // 0x06B0(0x000C) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
