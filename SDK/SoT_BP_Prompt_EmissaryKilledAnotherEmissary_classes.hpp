...
public:
	...
	FObjectMessagingHandle                             Handle_EmissaryKilledAnotherEmissary;                     // 0x0120(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)
	FName                                              CompanyName;                                              // 0x0168(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	FName                                              VictimCompanyName;                                        // 0x0170(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	FName                                              ExpectedCompanyName;                                      // 0x017C(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x0184(0x0004) MISSED OFFSET
	TArray<FName>                                      ExpectedVictimCompanyName;                                // 0x0188(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<FPrioritisedPromptWithHandle>               Prompts;                                                  // 0x0198(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	UClass*                                            PromptAccessKey;                                          // 0x01A8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	void OnEmissaryKilledAnotherEmissary(const FEmissaryKilledAnotherEmissaryNetworkEvent& NewParam);
	void EmissaryKilledAnotherEmisary(const FEmissaryKilledAnotherEmissaryNetworkEvent& NewParam);
	void Evaluate();
