...
{
public:
	class UReplenishableComponent*                     Replenishable;                                            // 0x0A60(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UPetHangoutSpotComponent*                    PetHangoutSpot;                                           // 0x0A68(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
