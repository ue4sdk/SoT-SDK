...
public:
	...
	float                                              BeaconConnectionInitialTimeout;                           // 0x0468(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              BeaconConnectionTimeout;                                  // 0x046C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
...
public:
	...
	class UNetConnection*                              BeaconConnection;                                         // 0x0490(0x0008) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBeaconConnectionState>                ConnectionState;                                          // 0x0498(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x17];                                      // 0x0499(0x0017) MISSED OFFSET
...
public:
	...
	class FString                                      DestSessionId;                                            // 0x04C0(0x0010) (ZeroConstructor)
	struct FPartyReservation                           PendingReservation;                                       // 0x04D0(0x0030)
	TEnumAsByte<EClientRequestType>                    RequestType;                                              // 0x0500(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bPendingReservationSent;                                  // 0x0501(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCancelReservation;                                       // 0x0502(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UClass*                                      ClientBeaconActorClass;                                   // 0x0470(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class UPartyBeaconState*                           State;                                                    // 0x0488(0x0008) (ZeroConstructor, IsPlainOldData)
