...
// 0x0050 (0x345C8 - 0x34578)
class UIpConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x50];                                      // 0x34578(0x0050) MISSED OFFSET
...
public:
	...
	TEnumAsByte<EBeaconConnectionState>                ConnectionState;                                          // 0x04E8(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	class FString                                      DestSessionId;                                            // 0x0510(0x0010) (ZeroConstructor)
	struct FPartyReservation                           PendingReservation;                                       // 0x0520(0x0030)
	TEnumAsByte<EClientRequestType>                    RequestType;                                              // 0x0550(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData01[0x5];                                       // 0x0553(0x0005) MISSED OFFSET
...
{
public:
	class FString                                      BeaconTypeName;                                           // 0x04B0(0x0010) (ZeroConstructor, Transient)
...
public:
	...
	float                                              SessionTimeoutSecs;                                       // 0x0508(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
	float                                              TravelSessionTimeoutSecs;                                 // 0x050C(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
