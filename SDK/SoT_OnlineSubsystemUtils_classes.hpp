...
// 0x0050 (0x345B8 - 0x34568)
class UIpConnection : public UNetConnection
{
public:
	unsigned char                                      UnknownData00[0x50];                                      // 0x34568(0x0050) MISSED OFFSET
...
public:
	...
	float                                              BeaconConnectionInitialTimeout;                           // 0x04B0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	float                                              BeaconConnectionTimeout;                                  // 0x04B4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	class UNetDriver*                                  NetDriver;                                                // 0x04B8(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class AOnlineBeaconHostObject*                     BeaconOwner;                                              // 0x04D0(0x0008) (ZeroConstructor, IsPlainOldData)
	class UNetConnection*                              BeaconConnection;                                         // 0x04D8(0x0008) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EBeaconConnectionState>                ConnectionState;                                          // 0x04E0(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x17];                                      // 0x04E1(0x0017) MISSED OFFSET
...
public:
	...
	class FString                                      DestSessionId;                                            // 0x0508(0x0010) (ZeroConstructor)
	struct FPartyReservation                           PendingReservation;                                       // 0x0518(0x0030)
	TEnumAsByte<EClientRequestType>                    RequestType;                                              // 0x0548(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bPendingReservationSent;                                  // 0x0549(0x0001) (ZeroConstructor, IsPlainOldData)
	bool                                               bCancelReservation;                                       // 0x054A(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	int                                                ListenPort;                                               // 0x04D0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x04D4(0x0004) MISSED OFFSET
	TArray<class AOnlineBeaconClient*>                 ClientActors;                                             // 0x04D8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData01[0xA0];                                      // 0x04E8(0x00A0) MISSED OFFSET
...
{
public:
	class FString                                      BeaconTypeName;                                           // 0x04A8(0x0010) (ZeroConstructor, Transient)
	class UClass*                                      ClientBeaconActorClass;                                   // 0x04B8(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class UPartyBeaconState*                           State;                                                    // 0x04D0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x28];                                      // 0x04D8(0x0028) MISSED OFFSET
	float                                              SessionTimeoutSecs;                                       // 0x0500(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
	float                                              TravelSessionTimeoutSecs;                                 // 0x0504(0x0004) (ZeroConstructor, Transient, Config, IsPlainOldData)
