...
public:
	...
	FObjectMessagingHandle                             Handle_EmissarySunk;                                      // 0x0120(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	void OnEmissarySunk(const FEmissarySunkNetworkEvent& NewParam);
	void EmissarySunk(const FEmissarySunkNetworkEvent& NewParam);
	void Evaluate();
