...
enum class EObjectTypeQuery : uint8_t
{
	...
	ObjectTypeQuery17              = 9,
	None04                         = 10,
	ObjectTypeQuery21              = 11,
	None05                         = 12,
	ObjectTypeQuery25              = 13,
	None06                         = 14,
	ObjectTypeQuery29              = 15,
	None07                         = 16,
	Core                           = 17,
...
enum class ECollisionChannel : uint8_t
{
	...
	None05                         = 12,
	ECC_GameTraceChannel11         = 13,
	None06                         = 14,
	ECC_GameTraceChannel15         = 15,
	None07                         = 16,
...
enum class EMoveComponentAction : uint8_t
{
	...
	None                           = 1,
	EAnimNotifyUnderwaterMode__AutoDetect = 2
};
...
enum class EPhysicalSurface : uint8_t
{
	...
	None22                         = 39,
	ipg_eas_belt_01                = 40,
	ipg_eas_belt_01_v03            = 41,
	ipg_eas_belt_02_v02            = 42,
	ipg_eas_belt_03                = 43,
	ipg_eas_boots_01_v02           = 44,
	ipg_eas_boots_02               = 45,
	ipg_eas_boots_02_v03           = 46,
	ipg_eas_dress_01_v02           = 47,
	ipg_eas_dress_02               = 48
};
...
enum class ESimplygonMaterialChannel : uint8_t
{
	...
	StructProperty                 = 6,
	None03                         = 7,
	ENetworkFailure__NetDriverAlreadyExists = 8,
	None04                         = 9
};
...
enum class ETextureGroup : uint8_t
{
	...
	None01                         = 3,
	NameProperty                   = 4,
	TEXTUREGROUP_WeaponSpecular    = 5,
	None02                         = 6,
	TEXTUREGROUP_Cinematic         = 7,
	None03                         = 8,
	TEXTUREGROUP_UI                = 9,
	None04                         = 10,
	TEXTUREGROUP_ProcBuilding_Face = 11,
	None05                         = 12,
	TEXTUREGROUP_Terrain_Heightmap = 13,
	None06                         = 14,
	TEXTUREGROUP_Pixels2D          = 15,
	None07                         = 16,
	TEXTUREGROUP_Coherent          = 17,
	None08                         = 18,
	DominanceGroup                 = 19,
	IntProperty                    = 20,
	IntProperty01                  = 21,
...
enum class EHIKEffector : uint8_t
{
	...
	HIKEffector_Last               = 22,
	None11                         = 23,
	AllocateNewRandomContinuousEmote = 24,
	GetCharacterPitch              = 25,
	GetTargetingPitch              = 26,
	OnEventAllocateShopInteractionAnimations = 27
};
...
enum class EHIKLookAtLimits : uint8_t
{
	...
	None                           = 1,
	EHIKLookAtInterpolation_Constant = 2
};
...
enum class EEvaluatorMode : uint8_t
{
	...
	None                           = 1,
	EMemoryGatheringMode__Exclusive = 2
};
...
struct FFFTWaterComponentIntersectParticleType
{
	...
	struct FVector2D                                   FoamRange;                                                // 0x0008(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              Density;                                                  // 0x0010(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              VolumeHorizontalVelocityWeight;                           // 0x0014(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              HorizontalDirectionFromVolumeWeight;                      // 0x0018(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              HorizontalRandomVelocityWeight;                           // 0x001C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              VolumeVerticalVelocityWeight;                             // 0x0020(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              VerticalRandomVelocityWeight;                             // 0x0024(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              WaterVelocityWeight;                                      // 0x0028(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              VelocityScaling;                                          // 0x002C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnderwaterParticles : 1;                                  // 0x0030(0x0001) (Edit)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0031(0x0007) MISSED OFFSET
	class UParticleComputeShaderData*                  ParticleComputeShaderData;                                // 0x0038(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FFFTWaterComponentParticleParams
{
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FFFTWaterComponentWaveParticleType          WaveParticles[0x6];                                       // 0x0008(0x0038) (Edit)
	struct FFFTWaterComponentIntersectParticleType     IntersectionParticles[0x2];                               // 0x0158(0x0040) (Edit)
};
...
struct FFFTWaterComponentParams
{
	...
	struct FFFTWaterComponentParticleParams            ParticleParams;                                           // 0x00B8(0x01D8) (Edit)
	float                                              ExtendedPlaneSize;                                        // 0x0290(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              ExtendedPlaneFadeDistance;                                // 0x0294(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FKSphereElem : public FKShapeElem
{
	...
	struct FVector                                     Center;                                                   // 0x0060(0x000C) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	float                                              Radius;                                                   // 0x006C(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
};
...
struct FKBoxElem : public FKShapeElem
{
	...
	float                                              X;                                                        // 0x0080(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	float                                              Y;                                                        // 0x0084(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	float                                              Z;                                                        // 0x0088(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
...
struct FKSphylElem : public FKShapeElem
{
	...
	float                                              Length;                                                   // 0x0084(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
...
struct FGPUSpriteEmitterInfo
{
	...
	TArray<class UParticleModule*>                     SpawnModules;                                             // 0x0028(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData00[0x8];                                       // 0x0038(0x0008) MISSED OFFSET
	struct FGPUSpriteLocalVectorFieldInfo              LocalVectorField;                                         // 0x0040(0x0070)
	struct FFloatDistribution                          VectorFieldScale;                                         // 0x00B0(0x0028) (ZeroConstructor)
	struct FFloatDistribution                          DragCoefficient;                                          // 0x00D8(0x0028) (ZeroConstructor)
	struct FFloatDistribution                          DragLocalVelocityCoefficient;                             // 0x0100(0x0028) (ZeroConstructor)
	struct FFloatDistribution                          PointAttractorStrength;                                   // 0x0128(0x0028) (ZeroConstructor)
	struct FFloatDistribution                          Resilience;                                               // 0x0150(0x0028) (ZeroConstructor)
	struct FVector                                     ConstantAcceleration;                                     // 0x0178(0x000C) (ZeroConstructor, IsPlainOldData)
	struct FVector                                     PointAttractorPosition;                                   // 0x0184(0x000C) (ZeroConstructor, IsPlainOldData)
	float                                              PointAttractorRadiusSq;                                   // 0x0190(0x0004) (ZeroConstructor, IsPlainOldData)
	struct FVector                                     OrbitOffsetBase;                                          // 0x0194(0x000C) (ZeroConstructor, IsPlainOldData)
	struct FVector                                     OrbitOffsetRange;                                         // 0x01A0(0x000C) (ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   InvMaxSize;                                               // 0x01AC(0x0008) (ZeroConstructor, IsPlainOldData)
	float                                              InvRotationRateScale;                                     // 0x01B4(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              MaxLifetime;                                              // 0x01B8(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                MaxParticleCount;                                         // 0x01BC(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EParticleScreenAlignment>              ScreenAlignment;                                          // 0x01C0(0x0001) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EParticleAxisLock>                     LockAxisFlag;                                             // 0x01C1(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x2];                                       // 0x01C2(0x0002) MISSED OFFSET
	unsigned char                                      bEnableCollision : 1;                                     // 0x01C4(0x0001)
	unsigned char                                      bNeedsVectorFields : 1;                                   // 0x01C4(0x0001)
	unsigned char                                      UnknownData02[0x3];                                       // 0x01C5(0x0003) MISSED OFFSET
	TEnumAsByte<EParticleCollisionMode>                CollisionMode;                                            // 0x01C8(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	struct FVector4                                    MurkyColorScale;                                          // 0x02B0(0x0010) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData04[0x10];                                      // 0x02C0(0x0010) MISSED OFFSET
};
...
struct FGPUSpriteResourceData
{
	...
	unsigned char                                      UnknownData01[0x288];                                     // 0x01C4(0x0288) MISSED OFFSET
	float                                              AlignmentInheritedVelocityScale;                          // 0x044C(0x0004) (ZeroConstructor, IsPlainOldData)
