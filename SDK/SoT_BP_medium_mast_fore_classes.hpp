...
public:
	...
	class UStaticMeshComponent*                        shp_flag_pennant_pole_01_a;                               // 0x0990(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        shp_flag_pennant_alliance_01_a;                           // 0x0998(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
