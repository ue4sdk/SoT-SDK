...
public:
	...
	UCapsuleComponent*                                 InnerCapsule;                                             // 0x03D8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	UCapsuleComponent*                                 OuterCapsule;                                             // 0x03E0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	bool                                               IsUnderwaterZone;                                         // 0x0414(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
