...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_ReefIslandWashedUpTreasureArtifactsSpawner.BP_ReefIslandWashedUpTreasureArtifactsSpawner_C");
		return ptr;
	}
