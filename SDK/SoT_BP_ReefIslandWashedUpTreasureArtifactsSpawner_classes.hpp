...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_ReefIslandWashedUpTreasureArtifactsSpawner.BP_ReefIslandWashedUpTreasureArtifactsSpawner_C");
		return ptr;
	}
