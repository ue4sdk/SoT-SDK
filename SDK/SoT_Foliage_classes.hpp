...
public:
	...
	struct FVector                                     TouchingActorEntryPosition;                               // 0x04C8(0x000C) (ZeroConstructor, Transient, IsPlainOldData)
	struct FVector                                     FoliageVelocity;                                          // 0x04D4(0x000C) (ZeroConstructor, Transient, IsPlainOldData)
	struct FVector                                     FoliageForce;                                             // 0x04E0(0x000C) (ZeroConstructor, Transient, IsPlainOldData)
	struct FVector                                     FoliagePosition;                                          // 0x04EC(0x000C) (ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	class AProceduralFoliageVolume*                    ProceduralFoliageVolume;                                  // 0x04E8(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UProceduralFoliageComponent*                 ProceduralComponent;                                      // 0x04E8(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
