...
{
public:
	class UEnvQuery*                                   QueryTemplate;                                            // 0x0690(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FEnvNamedValue>                      QueryParams;                                              // 0x0698(0x0010) (Edit, ZeroConstructor)
	float                                              TimeLimitPerStep;                                         // 0x06A8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                StepToDebugDraw;                                          // 0x06AC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EEnvQueryHightlightMode>               HighlightMode;                                            // 0x06B0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x06B1(0x0003) MISSED OFFSET
	unsigned char                                      bDrawLabels : 1;                                          // 0x06B4(0x0001) (Edit)
	unsigned char                                      bDrawFailedItems : 1;                                     // 0x06B4(0x0001) (Edit)
	unsigned char                                      bReRunQueryOnlyOnFinishedMove : 1;                        // 0x06B4(0x0001) (Edit)
	unsigned char                                      bShouldBeVisibleInGame : 1;                               // 0x06B4(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x3];                                       // 0x06B5(0x0003) MISSED OFFSET
	TEnumAsByte<EEnvQueryRunMode>                      QueryingMode;                                             // 0x06B8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x37];                                      // 0x06B9(0x0037) MISSED OFFSET
