...
public:
	...
	struct FScriptMulticastDelegate                    ReceiveMoveCompleted;                                     // 0x0540(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData03[0x10];                                      // 0x0550(0x0010) MISSED OFFSET
