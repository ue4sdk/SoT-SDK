...
public:
	...
	unsigned char                                      bLOSflag : 1;                                             // 0x0528(0x0001)
	unsigned char                                      bSkipExtraLOSChecks : 1;                                  // 0x0528(0x0001)
	unsigned char                                      bAllowStrafe : 1;                                         // 0x0528(0x0001)
	unsigned char                                      bWantsPlayerState : 1;                                    // 0x0528(0x0001)
	unsigned char                                      bDisableControlRotation : 1;                              // 0x0528(0x0001)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0529(0x0007) MISSED OFFSET
	class UPathFollowingComponent*                     PathFollowingComponent;                                   // 0x0530(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UBrainComponent*                             BrainComponent;                                           // 0x0538(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAIPerceptionComponent*                      PerceptionComponent;                                      // 0x0540(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UPawnActionsComponent*                       ActionsComp;                                              // 0x0548(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlackboardComponent*                        Blackboard;                                               // 0x0550(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UGameplayTasksComponent*                     CachedGameplayTasksComponent;                             // 0x0558(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData02[0x10];                                      // 0x0560(0x0010) MISSED OFFSET
	struct FScriptMulticastDelegate                    ReceiveMoveCompleted;                                     // 0x0570(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	class UEnvQuery*                                   QueryTemplate;                                            // 0x06A0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<struct FEnvNamedValue>                      QueryParams;                                              // 0x06A8(0x0010) (Edit, ZeroConstructor)
	float                                              TimeLimitPerStep;                                         // 0x06B8(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                StepToDebugDraw;                                          // 0x06BC(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<EEnvQueryHightlightMode>               HighlightMode;                                            // 0x06C0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x06C1(0x0003) MISSED OFFSET
	unsigned char                                      bDrawLabels : 1;                                          // 0x06C4(0x0001) (Edit)
	unsigned char                                      bDrawFailedItems : 1;                                     // 0x06C4(0x0001) (Edit)
	unsigned char                                      bReRunQueryOnlyOnFinishedMove : 1;                        // 0x06C4(0x0001) (Edit)
	unsigned char                                      bShouldBeVisibleInGame : 1;                               // 0x06C4(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x3];                                       // 0x06C5(0x0003) MISSED OFFSET
	TEnumAsByte<EEnvQueryRunMode>                      QueryingMode;                                             // 0x06C8(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x37];                                      // 0x06C9(0x0037) MISSED OFFSET
