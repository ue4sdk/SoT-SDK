...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_ResourceIslandWashedUpTreasureArtifactsSpawner.BP_ResourceIslandWashedUpTreasureArtifactsSpawner_C");
		return ptr;
	}
