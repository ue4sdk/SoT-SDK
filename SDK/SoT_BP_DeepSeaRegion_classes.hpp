...
{
public:
	UCapsuleComponent*                                 PreviewCapsuleTwo;                                        // 0x0440(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	UCapsuleComponent*                                 PreviewCapsuleOne;                                        // 0x0448(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
