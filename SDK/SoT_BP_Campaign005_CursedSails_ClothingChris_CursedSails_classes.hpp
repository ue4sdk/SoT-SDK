...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_Campaign005_CursedSails_ClothingChris_CursedSails.BP_Campaign005_CursedSails_ClothingChris_CursedSails_C");
		return ptr;
	}
