...
public:
	...
	class UShipFireVFXManager*                         VFXManager;                                               // 0x0148(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	struct FShipFireVfxSpawnSettings                   VfxSpawnSettings;                                         // 0x0150(0x0058) (Edit, DisableEditOnInstance)
	struct FShipFireLightManager                       FireLightManager;                                         // 0x01A8(0x0140) (Edit, DisableEditOnInstance)
	struct FShipFireCharringManager                    FireCharringManager;                                      // 0x02E8(0x00B8) (Edit, DisableEditOnInstance)
	...
	class UShipFireAudioManager*                       FireAudioManager;                                         // 0x03C8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
