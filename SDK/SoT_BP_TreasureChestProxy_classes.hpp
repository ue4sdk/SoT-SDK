...
{
public:
	class UGlintComponent*                             Glint;                                                    // 0x09C0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UInteractableComponent*                      Interactable;                                             // 0x09C8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
