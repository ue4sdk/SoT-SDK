...
public:
	...
	TArray<USceneComponent*>                           ComponentsToDrop;                                         // 0x03E8(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	TArray<UPhysicalMaterial*>                         Physical_Materials_To_Ignore;                             // 0x0400(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	...
	void Get_Valid_Collision(bool Hit_Success, USceneComponent* Current_Component, TArray<FHitResult>* Hit_Results, bool* Return_Value, FVector* Impact_Position, FVector* Impact_Normal);
