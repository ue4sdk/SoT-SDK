...
public:
	...
	FObjectMessagingHandle                             Handle_EmissaryStoleLoot;                                 // 0x0120(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	void OnEmissaryStoleLoot(const FEmissaryStoleLootNetworkEvent& NewParam);
	void EmissaryStoleLoot(const FEmissaryStoleLootNetworkEvent& NewParam);
	void Evaluate();
