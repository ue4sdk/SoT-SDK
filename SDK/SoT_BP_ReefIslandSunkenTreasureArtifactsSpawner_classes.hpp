...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_ReefIslandSunkenTreasureArtifactsSpawner.BP_ReefIslandSunkenTreasureArtifactsSpawner_C");
		return ptr;
	}
