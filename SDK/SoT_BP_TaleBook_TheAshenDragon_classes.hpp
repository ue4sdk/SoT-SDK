...
#include "SoT_BP_TaleBook_TheAshenDragon_structs.hpp"
...
// BlueprintGeneratedClass BP_TaleBook_TheAshenDragon.BP_TaleBook_TheAshenDragon_C
// 0x0030 (0x0740 - 0x0710)
class ABP_TaleBook_TheAshenDragon_C : public AVoyageProposalContainer
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_TaleBook_TheAshenDragon.BP_TaleBook_TheAshenDragon_C"));
		return ptr;
	}
