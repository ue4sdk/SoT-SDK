...
#include "SoT_BP_gmp_compass_wth_01_a_ItemInfo_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_gmp_compass_wth_01_a_ItemInfo.BP_gmp_compass_wth_01_a_ItemInfo_C"));
		return ptr;
	}
