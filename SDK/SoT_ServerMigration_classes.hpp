...
{
public:
	class UChildActorComponent*                        ChildActorComponent;                                      // 0x0478(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
{
public:
	struct FNetActorPtr                                ActorPtr;                                                 // 0x0478(0x0014)
...
{
public:
	struct FUniqueNetIdRepl                            UniqueId;                                                 // 0x0478(0x0018)
...
{
public:
	class UServerMigrationSerialisationDetailsTestsMigratableComponent* ComponentWithMigrationMarkup;                             // 0x0478(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
{
public:
	class UChildActorComponent*                        Component;                                                // 0x0478(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
{
public:
	struct FServerMigrationCustomMigrationSerialisationStruct TestStruct;                                               // 0x0478(0x0004)
...
{
public:
	class AActor*                                      DependentActor;                                           // 0x0478(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class AActor*                                      ActorReferenceWithMigrationMarkup;                        // 0x0478(0x0008) (ZeroConstructor, IsPlainOldData)
