...
public:
	...
	FObjectMessagingHandle                             Handle_EmissaryEncounteredSkellyFort;                     // 0x0120(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	void OnEmissaryEncounteredSkellyFort(const FEmissaryEncounteredSkellyFortNetworkEvent& NewParam);
	void EmissaryEncounteredSkellyFort(const FEmissaryEncounteredSkellyFortNetworkEvent& NewParam);
	void Evaluate();
