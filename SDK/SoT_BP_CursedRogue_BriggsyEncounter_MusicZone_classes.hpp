...
#include "SoT_BP_CursedRogue_BriggsyEncounter_MusicZone_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_CursedRogue_BriggsyEncounter_MusicZone.BP_CursedRogue_BriggsyEncounter_MusicZone_C"));
		return ptr;
	}
