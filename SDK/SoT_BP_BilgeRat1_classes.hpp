...
public:
	...
	class UStaticMeshComponent*                        tls_tankard_01_a;                                         // 0x0580(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_BilgeRat1.BP_BilgeRat1_C");
		return ptr;
	}
