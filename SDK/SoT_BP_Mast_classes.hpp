...
public:
	...
	class UChildActorComponent*                        TopgallantActor;                                          // 0x0700(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UChildActorComponent*                        TopsailActor;                                             // 0x0708(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        Mast_Top_StaticMesh;                                      // 0x0710(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
