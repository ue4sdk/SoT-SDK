...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_MerchantCrate_CannonballCrate_ItemInfo.BP_MerchantCrate_CannonballCrate_ItemInfo_C");
		return ptr;
	}
