...
public:
	...
	class UCapsuleComponent*                           PlayerHits;                                               // 0x09E0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USkeletalMeshComponent*                      SkeletalMesh;                                             // 0x09E8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UCapsuleComponent*                           WorldHits;                                                // 0x09F0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
