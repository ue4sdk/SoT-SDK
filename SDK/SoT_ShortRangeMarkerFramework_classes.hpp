...
public:
	...
	TArray<UMaterialInstanceDynamic*>                  DynamicMaterials;                                         // 0x03E0(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient)
	...
	FScriptMulticastDelegate                           TriggerFadeIn;                                            // 0x03F8(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	FScriptMulticastDelegate                           TriggerFadeOut;                                           // 0x0408(0x0010) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	static void RegisterActorsWithShortRangeMarker(UObject* WorldContextObject, AActor* InMarker, TArray<AActor*>* InActors);
};
...
{
public:
	UActorSpawnData*                                   RewardMarker;                                             // 0x0028(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
