...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_ShipwreckTreasureChest_ItemInfo_Common-.BP_ShipwreckTreasureChest_ItemInfo_Common-_C");
		return ptr;
	}
