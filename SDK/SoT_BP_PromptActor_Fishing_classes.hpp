...
public:
	...
	class UBP_Prompt_MaidenVoyage_FishingRodTutorial_C* PromptCoordinator;                                        // 0x0470(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
