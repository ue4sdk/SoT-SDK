...
#include "SoT_BP_LotS_reward039_structs.hpp"
...
class ABP_LotS_reward039_C : public AModalInteractionProxy
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_LotS_reward039.BP_LotS_reward039_C"));
		return ptr;
	}
