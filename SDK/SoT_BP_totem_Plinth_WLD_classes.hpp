...
#include "SoT_BP_totem_Plinth_WLD_structs.hpp"
...
// BlueprintGeneratedClass BP_totem_Plinth_WLD.BP_totem_Plinth_WLD_C
// 0x0018 (0x04C8 - 0x04B0)
class ABP_totem_Plinth_WLD_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_totem_Plinth_WLD.BP_totem_Plinth_WLD_C"));
		return ptr;
	}
