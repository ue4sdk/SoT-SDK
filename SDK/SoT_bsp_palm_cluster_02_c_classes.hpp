...
{
public:
	class UStaticMeshComponent*                        wsp_rock_xtra_small__b;                                   // 0x04B0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        wsp_rock_xtra_small__e;                                   // 0x04B8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        wsp_rock_xtra_small__d;                                   // 0x04C0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        wsp_tree_palm_01_b;                                       // 0x04C8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UStaticMeshComponent*                        wsp_tree_palm_01_a;                                       // 0x04D8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UStaticMeshComponent*                        wsp_bush_06_a_1;                                          // 0x04F0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
