...
public:
	...
	class UStaticMeshComponent*                        wsp_bush_06_b2_1;                                         // 0x04E8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        wsp_bush_06_b3_1;                                         // 0x04F0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass bsp_tr_cluster_01_k.bsp_tr_cluster_01_k_C");
		return ptr;
	}
