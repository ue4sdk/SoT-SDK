...
public:
	...
	UClass*                                            RequiredShantyItemDesc;                                   // 0x02B8(0x0008) (Edit, ZeroConstructor, DisableEditOnTemplate, IsPlainOldData)
	TArray<FShantyPuzzleInteractionZoneDefinition>     ShantyPuzzleInteractionZoneDefinitions;                   // 0x02C0(0x0010) (Edit, ZeroConstructor, DisableEditOnTemplate)
	...
	FGameTimeRange                                     ActiveTimeRange;                                          // 0x02D8(0x0010) (Edit)
	TArray<UShantyPuzzleInteractionZoneComponent*>     ShantyPuzzleInteractionZones;                             // 0x02E8(0x0010) (ExportObject, ZeroConstructor)
	AEnsemble*                                         CurrentlyPlayingShantyPuzzleEnsemble;                     // 0x02F8(0x0008) (ZeroConstructor, IsPlainOldData)
	...
	void OnEndOverlap(AActor* InActor, UPrimitiveComponent* InComponent, int InOtherBodyIndex);
	void OnBeginOverlap(AActor* InActor, UPrimitiveComponent* InComponent, int InOtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult);
};
