...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass AD_FirstPerson_PlayerPirate_Female_Thin.AD_FirstPerson_PlayerPirate_Female_Thin_C"));
		return ptr;
	}
