...
public:
	...
	TArray<struct FInstance_Struct>                    Instances;                                                // 0x04A8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	float                                              DrawDistance;                                             // 0x04B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
