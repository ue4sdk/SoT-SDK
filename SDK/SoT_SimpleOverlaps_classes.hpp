...
public:
	...
	class UPrimitiveComponent*                         PrimitiveComponent;                                       // 0x04C8(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	unsigned char                                      UnknownData01[0xE8];                                      // 0x04D0(0x00E8) MISSED OFFSET
