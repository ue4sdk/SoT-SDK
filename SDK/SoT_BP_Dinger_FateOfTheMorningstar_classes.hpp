...
#include "SoT_BP_Dinger_FateOfTheMorningstar_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Dinger_FateOfTheMorningstar.BP_Dinger_FateOfTheMorningstar_C"));
		return ptr;
	}
