...
public:
	...
	class UMaterialInstanceConstant*                   MaterialInstance;                                         // 0x05A0(0x0008) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData02[0x10];                                      // 0x0650(0x0010) MISSED OFFSET
	...
	unsigned char                                      UnknownData04[0x30];                                      // 0x06B0(0x0030) MISSED OFFSET
...
public:
	...
	class ULandscapeSplinesComponent*                  SplineComponent;                                          // 0x03D8(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	struct FGuid                                       LandscapeGuid;                                            // 0x03E0(0x0010) (ZeroConstructor, IsPlainOldData)
	struct FIntPoint                                   LandscapeSectionOffset;                                   // 0x03F0(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	struct FGuid                                       LandscapeGuid;                                            // 0x05E0(0x0010) (ZeroConstructor, IsPlainOldData)
	TArray<struct FIntPoint>                           ProxyComponentBases;                                      // 0x05F0(0x0010) (ZeroConstructor)
	int8_t                                             ProxyLOD;                                                 // 0x0600(0x0001) (ZeroConstructor, IsPlainOldData)
