...
{
public:
	class UMusicZoneComponent*                         AnticipationMusicZone;                                    // 0x0410(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UAISpawnerMusicZoneComponent*                AISpawnerMusicZone;                                       // 0x0418(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
