...
public:
	...
	class UStaticMeshComponent*                        Token_1;                                                  // 0x0590(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FWwiseEmitter                               Sound_Emitter;                                            // 0x05D0(0x0020) (Edit, BlueprintVisible, DisableEditOnInstance)
	float                                              Show_Token_Animation_Time;                                // 0x05F0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x05F4(0x0004) MISSED OFFSET
	class UMaterialInterface*                          Token_Material;                                           // 0x05F8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
