...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BarrelItemTypes_Special_CursedCannonballs.BarrelItemTypes_Special_CursedCannonballs_C");
		return ptr;
	}
