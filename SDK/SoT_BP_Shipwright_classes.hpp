...
public:
	...
	class UNPCDialogComponent*                         NPCDialogComponent;                                       // 0x05A0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FWwiseEmitter                               WwiseEmitter;                                             // 0x05B8(0x0020) (Edit, BlueprintVisible, DisableEditOnInstance)
	class UWwiseEvent*                                 WwiseShipwrightHummingPlay;                               // 0x05D8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UWwiseEvent*                                 WwiseShipwrightHummingStop;                               // 0x05E0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
