...
public:
	...
	class UNPCDialogComponent*                         NPCDialogComponent;                                       // 0x05C0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UWwiseEvent*                                 WwiseShipwrightHummingPlay;                               // 0x05F8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UWwiseEvent*                                 WwiseShipwrightHummingStop;                               // 0x0600(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
