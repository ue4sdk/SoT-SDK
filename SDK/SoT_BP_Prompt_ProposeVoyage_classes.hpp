...
public:
	...
	FObjectMessagingHandle                             Handle_OnOfferPurchased;                                  // 0x0128(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	FPrioritisedPromptWithHandle                       Prompt_ProposeVoyage;                                     // 0x0178(0x0068) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	void PostInitialize();
	void Prompt_OfferPurchased(const FAthena_FOfferPurchasedEvent& Ev);
