...
public:
	...
	UBP_Prompt_TunnelOfTheDamned_BootyWillBeLost_C*    PromptCoordinator;                                        // 0x0410(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
