...
{
public:
	class UCommoditySourceComponent*                   CommoditySource;                                          // 0x07A0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UCrateFillerComponent*                       CrateFiller;                                              // 0x07A8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
