...
class ABP_SaltyParrot_TheArtOfTheTrickster_C : public ANPC
{
public:
	class UActorPhasingComponent*                      ActorPhasing;                                             // 0x0588(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
