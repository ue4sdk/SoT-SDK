...
#include "SoT_BP_Campaign018_ReapersBones_Proxy_Base_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Campaign018_ReapersBones_Proxy_Base.BP_Campaign018_ReapersBones_Proxy_Base_C"));
		return ptr;
	}
