...
{
public:
	class UWwiseEmitterComponent*                      AudioComp;                                                // 0x04A0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<class UWwiseEvent*>                         WwisePlayEvents;                                          // 0x04A8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	...
	TArray<class UWwiseEvent*>                         WwiseStopEvents;                                          // 0x04D0(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
