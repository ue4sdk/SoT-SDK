...
public:
	...
	struct FADS_DeathNative                            Death;                                                    // 0x0568(0x0020) (Edit, BlueprintVisible)
	...
	struct FADS_DiverseEmoteNative                     EmoteDiverse;                                             // 0x0608(0x0010) (Edit, BlueprintVisible)
	struct FADS_PersonaNative                          EmotePersonas;                                            // 0x0618(0x0010) (Edit, BlueprintVisible)
	...
	struct FADS_SkeletonCurseNative                    SkeletonCurse;                                            // 0x0718(0x0028) (Edit, BlueprintVisible)
	struct FADS_WaterPumpNative                        WaterPump;                                                // 0x0740(0x0028) (Edit, BlueprintVisible)
