...
#include "SoT_BP_cmn_cannonball_Grenade_Scatter_ItemInfo_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_cmn_cannonball_Grenade_Scatter_ItemInfo.BP_cmn_cannonball_Grenade_Scatter_ItemInfo_C"));
		return ptr;
	}
