...
public:
	...
	class ABP_Audio_Play_Wwise_Event_Function_C*       Arena_Audio_Comp_ExecuteUbergraph_sot_frontend_01_arena_start_anim_RefProperty;// 0x03E0(0x0008) (ZeroConstructor, IsPlainOldData)
	class AMatineeActor*                               ArenaTutorial_Matinee_ExecuteUbergraph_sot_frontend_01_arena_start_anim_RefProperty;// 0x03E8(0x0008) (ZeroConstructor, IsPlainOldData)
