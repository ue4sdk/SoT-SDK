...
#include "SoT_BP_MerchantCrate_AIShipAnyItemCrate_Proxy_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_MerchantCrate_AIShipAnyItemCrate_Proxy.BP_MerchantCrate_AIShipAnyItemCrate_Proxy_C"));
		return ptr;
	}
