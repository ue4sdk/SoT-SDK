...
#include "SoT_BP_fod_BananaFresh_00_a_Wieldable_parameters.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_fod_BananaFresh_00_a_Wieldable.BP_fod_BananaFresh_00_a_Wieldable_C.UserConstructionScript"));
