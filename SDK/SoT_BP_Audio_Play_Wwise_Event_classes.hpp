...
public:
	...
	class UWwiseEmitterComponent*                      BPAudioEvent;                                             // 0x0490(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TArray<class UWwiseEvent*>                         WwiseEvent;                                               // 0x0498(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
