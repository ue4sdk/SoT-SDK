...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_MerchantCrate_BigGunpowderBarrel_ItemInfo.BP_MerchantCrate_BigGunpowderBarrel_ItemInfo_C");
		return ptr;
	}
