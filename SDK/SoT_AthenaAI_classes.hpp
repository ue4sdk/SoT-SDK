...
public:
	...
	int                                                PriorityForSpawnedPawns;                                  // 0x00B4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	struct FTinySharkParams                            Params;                                                   // 0x0508(0x00A8) (Transient)
	unsigned char                                      UnknownData02[0x68];                                      // 0x05B0(0x0068) MISSED OFFSET
