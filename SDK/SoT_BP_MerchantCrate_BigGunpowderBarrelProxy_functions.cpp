...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function BP_MerchantCrate_BigGunpowderBarrelProxy.BP_MerchantCrate_BigGunpowderBarrelProxy_C.UserConstructionScript"));
