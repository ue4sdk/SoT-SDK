...
public:
	...
	FObjectMessagingHandle                             Handle_EmissaryEncounteredKraken;                         // 0x0120(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	void OnEmissaryEncounteredKraken(const FEmissaryEncounteredKrakenEvent& NewParam);
	void EmissaryEncounteredKraken(const FEmissaryEncounteredKrakenEvent& NewParam);
	void Evaluate();
