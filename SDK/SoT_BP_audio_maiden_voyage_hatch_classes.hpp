...
#include "SoT_BP_audio_maiden_voyage_hatch_structs.hpp"
...
// BlueprintGeneratedClass BP_audio_maiden_voyage_hatch.BP_audio_maiden_voyage_hatch_C
// 0x0030 (0x0490 - 0x0460)
class ABP_audio_maiden_voyage_hatch_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_audio_maiden_voyage_hatch.BP_audio_maiden_voyage_hatch_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_audio_maiden_voyage_hatch(int EntryPoint);
};
