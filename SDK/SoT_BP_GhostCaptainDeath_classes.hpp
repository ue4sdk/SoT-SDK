...
{
public:
	class UStaticMeshComponent*                        Book;                                                     // 0x04D0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UStaticMeshComponent*                        gmp_tal_enchanted_lantern_01_a;                           // 0x04D8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
