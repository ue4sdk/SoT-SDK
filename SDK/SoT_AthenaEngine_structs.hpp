...
struct FSerialisedRpc
{
	...
	UScriptStruct*                                     ContentsType;                                             // 0x0018(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
{
	FString                                            String;                                                   // 0x0000(0x0010) (Edit, ZeroConstructor)
	TAssetPtr<class UClass>                            AssetClass;                                               // 0x0010(0x0020) (Edit)
	TArray<FStringAssetClassPairFeatureOverride>       FeatureOverrides;                                         // 0x0030(0x0010) (Edit, ZeroConstructor)
};
...
{
	TArray<FString>                                    Tags;                                                     // 0x0000(0x0010) (ZeroConstructor)
	TArray<FString>                                    States;                                                   // 0x0010(0x0010) (ZeroConstructor)
...
{
	FString                                            StampId;                                                  // 0x0000(0x0010) (ZeroConstructor)
};
...
{
	FName                                              ComponentName;                                            // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	UActorComponent*                                   CachedComponent;                                          // 0x0008(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
};
...
{
	UWwiseEvent*                                       WwiseEvent;                                               // 0x0010(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
	UForceFeedbackEffect*                              ForceFeedbackEffect;                                      // 0x0000(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	FName                                              Tag;                                                      // 0x0008(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
struct FEventTriggerForceFeedback
{
	...
	FName                                              Tag;                                                      // 0x000C(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
