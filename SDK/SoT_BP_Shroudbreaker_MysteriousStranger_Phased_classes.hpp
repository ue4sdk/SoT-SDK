...
{
public:
	class UActorPhasingComponent*                      ActorPhasing;                                             // 0x0648(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UCapsuleComponent*                           SolidHits;                                                // 0x0650(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
