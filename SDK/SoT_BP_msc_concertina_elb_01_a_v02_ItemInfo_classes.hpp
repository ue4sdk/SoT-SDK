...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_msc_concertina_elb_01_a_v02_ItemInfo.BP_msc_concertina_elb_01_a_v02_ItemInfo_C"));
		return ptr;
	}
