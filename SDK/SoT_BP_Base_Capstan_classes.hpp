...
public:
	...
	class USphereComponent*                            ProjectileCollision;                                      // 0x0838(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UWwiseEmitterComponent*                      NewVar_1;                                                 // 0x0840(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
