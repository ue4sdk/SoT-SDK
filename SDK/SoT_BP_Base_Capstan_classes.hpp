...
public:
	...
	class USphereComponent*                            ProjectileCollision;                                      // 0x0880(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UWwiseEmitterComponent*                      NewVar_1;                                                 // 0x0888(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
