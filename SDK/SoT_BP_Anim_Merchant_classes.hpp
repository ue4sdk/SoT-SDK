...
// 0x000B (0x18F0 - 0x18E5)
class UBP_Anim_Merchant_C : public UBP_Anim_NPC_C
{
public:
	unsigned char                                      UnknownData00[0x3];                                       // 0x18E5(0x0003) MISSED OFFSET
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                           // 0x18E8(0x0008) (ZeroConstructor, Transient, DuplicateTransient)
