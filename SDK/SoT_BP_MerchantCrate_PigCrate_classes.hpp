...
public:
	...
	class UFeedingComponent*                           Feeding;                                                  // 0x0830(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMountpointComponent*                        Mountpoint;                                               // 0x0838(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
