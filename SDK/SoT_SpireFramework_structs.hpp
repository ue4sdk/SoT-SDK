...
struct FServerSpireInfo
{
	...
	AActor*                                            SpireActor;                                               // 0x0010(0x0008) (ZeroConstructor, IsPlainOldData)
	TMap<FString, FName>                               InstancedLevelPaths;                                      // 0x0018(0x0050) (ZeroConstructor)
};
...
struct FSpireEntry
{
	FVector                                            Location;                                                 // 0x0000(0x000C) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	FName                                              IslandName;                                               // 0x000C(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
};
