...
#include "SoT_BP_Crooked_Dressing_structs.hpp"
...
// BlueprintGeneratedClass BP_Crooked_Dressing.BP_Crooked_Dressing_C
// 0x0070 (0x04E0 - 0x0470)
class ABP_Crooked_Dressing_C : public AActor
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_Crooked_Dressing.BP_Crooked_Dressing_C"));
		return ptr;
	}
