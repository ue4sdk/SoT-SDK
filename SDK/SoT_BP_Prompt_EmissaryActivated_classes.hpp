...
public:
	...
	FObjectMessagingHandle                             Handle_EmissaryCompanyChangedEvent;                       // 0x0120(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)
	FName                                              CompanyName;                                              // 0x0168(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	FName                                              ExpectedCompanyName;                                      // 0x0170(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<FPrioritisedPromptWithHandle>               Prompts;                                                  // 0x0178(0x0010) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	...
	void OnEmissaryActivatedFunc(const FEmissaryLevel_FEmissaryActivated& NewParam);
	void EmissaryActivated(const FEmissaryLevel_FEmissaryActivated& NewParam);
	void Evaluate();
