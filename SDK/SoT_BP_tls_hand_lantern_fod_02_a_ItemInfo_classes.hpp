...
#include "SoT_BP_tls_hand_lantern_fod_02_a_ItemInfo_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_tls_hand_lantern_fod_02_a_ItemInfo.BP_tls_hand_lantern_fod_02_a_ItemInfo_C"));
		return ptr;
	}
