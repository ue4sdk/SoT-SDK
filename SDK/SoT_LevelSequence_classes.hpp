...
{
public:
	bool                                               bAutoPlay;                                                // 0x0480(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0481(0x0003) MISSED OFFSET
	struct FLevelSequencePlaybackSettings              PlaybackSettings;                                         // 0x0484(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly)
	...
	class ULevelSequenceInstance*                      SequenceInstance;                                         // 0x04A8(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
