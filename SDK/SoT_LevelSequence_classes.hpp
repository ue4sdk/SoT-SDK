...
public:
	...
	bool                                               bAutoPlay;                                                // 0x0468(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0469(0x0007) MISSED OFFSET
	struct FMovieSceneSequencePlaybackSettings         PlaybackSettings;                                         // 0x0470(0x0028) (Edit, BlueprintVisible, BlueprintReadOnly)
	class ULevelSequencePlayer*                        SequencePlayer;                                           // 0x0498(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, IsPlainOldData)
	struct FStringAssetReference                       LevelSequence;                                            // 0x04A0(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	...
	class AActor*                                      SpawnablesParent;                                         // 0x04C0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class ULevelSequenceBurnIn*                        BurnInInstance;                                           // 0x04C8(0x0008) (ZeroConstructor, IsPlainOldData)
