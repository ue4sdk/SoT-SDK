...
{
public:
	class UWaterHeightProviderComponent*               WaterHeightProvider;                                      // 0x0878(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UExplosiveTriggerRammableComponent*          ExplosiveTriggerRammable;                                 // 0x0880(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UFuseComponent*                              Fuse;                                                     // 0x0888(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UBoxComponent*                               AttackHitVolume;                                          // 0x08A0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UExplosionComponent*                         ExplosionComponent;                                       // 0x08A8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
