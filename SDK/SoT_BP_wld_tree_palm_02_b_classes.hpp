...
#include "SoT_BP_wld_tree_palm_02_b_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_wld_tree_palm_02_b.BP_wld_tree_palm_02_b_C"));
		return ptr;
	}
