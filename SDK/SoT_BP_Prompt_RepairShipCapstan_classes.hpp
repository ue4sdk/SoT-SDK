...
public:
	...
	FObjectMessagingHandle                             Handle_OnCapstanDamaged;                                  // 0x0128(0x0048) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	void OnShipDamaged(const FEventCapstanDamageLevelChanged& Event);
