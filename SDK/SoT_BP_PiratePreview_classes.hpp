...
public:
	...
	class UArrowComponent*                             Camera_SideView;                                          // 0x0838(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UArrowComponent*                             Camera_ProfileImage;                                      // 0x0840(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
