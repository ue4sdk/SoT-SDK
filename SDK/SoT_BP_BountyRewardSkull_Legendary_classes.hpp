...
{
public:
	class UParticleSystemComponent*                    VFX_Skull_Glow_1st;                                       // 0x0820(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UParticleSystemComponent*                    VFX_Skull_Glow_3rd;                                       // 0x0828(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
