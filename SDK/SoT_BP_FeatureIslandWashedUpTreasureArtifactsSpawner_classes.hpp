...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_FeatureIslandWashedUpTreasureArtifactsSpawner.BP_FeatureIslandWashedUpTreasureArtifactsSpawner_C");
		return ptr;
	}
