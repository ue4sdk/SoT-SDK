...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_FeatureIslandWashedUpTreasureArtifactsSpawner.BP_FeatureIslandWashedUpTreasureArtifactsSpawner_C");
		return ptr;
	}
