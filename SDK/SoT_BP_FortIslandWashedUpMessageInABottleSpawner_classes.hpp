...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_FortIslandWashedUpMessageInABottleSpawner.BP_FortIslandWashedUpMessageInABottleSpawner_C");
		return ptr;
	}
