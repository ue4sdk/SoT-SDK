...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass sailslivery_blueroyal_01_CustomizationDesc.sailslivery_blueroyal_01_CustomizationDesc_C"));
		return ptr;
	}
