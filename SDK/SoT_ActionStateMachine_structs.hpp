...
{
	FSerialisedActionStateInfo                         SerialisedConstructionInfo[0x5];                          // 0x0000(0x0040)
};
...
{
	FActionStateChangeRequestId                        LatestEpochIds[0x5];                                      // 0x0000(0x0001)
	FActionStateChangeRequestId                        LatestRequestIds[0x5];                                    // 0x0005(0x0001)
	unsigned char                                      UnknownData00[0x6];                                       // 0x000A(0x0006) MISSED OFFSET
	FSerialisedConstructionInfoStore                   PerTrackConstructionInfoStore;                            // 0x0010(0x0140)
};
...
struct FActionStateSerialisableData
{
	...
	UClass*                                            Id;                                                       // 0x0008(0x0008) (ZeroConstructor, IsPlainOldData)
	UScriptStruct*                                     Type;                                                     // 0x0010(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
	UClass*                                            State;                                                    // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<FActionStatePriorityRelationship>           Entries;                                                  // 0x0008(0x0010) (Edit, ZeroConstructor)
};
...
{
	UClass*                                            Id;                                                       // 0x0000(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	UScriptStruct*                                     Type;                                                     // 0x0008(0x0008) (ZeroConstructor, IsPlainOldData)
...
struct FInnerTestStruct
{
	...
	FString                                            StringProp;                                               // 0x0008(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
};
...
struct FTestActionStateConstructionInfoWithInner : public FActionStateConstructionInfo
{
	...
	FInnerTestStruct                                   InnerStruct;                                              // 0x0030(0x0018) (BlueprintVisible, BlueprintReadOnly)
};
...
{
	unsigned char                                      UnknownData00[0x8];                                       // 0x0000(0x0008) MISSED OFFSET
	UScriptStruct*                                     Type;                                                     // 0x0008(0x0008) (ZeroConstructor, IsPlainOldData, RepSkip, RepNotify, Interp, NonTransactional, EditorOnly, NoDestructor, AutoWeak, ContainsInstancedReference, AssetRegistrySearchable, SimpleDisplay, AdvancedDisplay, Protected, BlueprintCallable, BlueprintAuthorityOnly, TextExportTransient, NonPIEDuplicateTransient, ExposeOnSpawn, PersistentInstance, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic, NativeAccessSpecifierProtected, NativeAccessSpecifierPrivate)
};
...
{
	UObject*                                           ObjPointer;                                               // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
};
...
{
	UObject*                                           ObjPointer;                                               // 0x0028(0x0008) (ZeroConstructor, IsPlainOldData)
	FInnerWithObjTestStruct                            Inner;                                                    // 0x0030(0x0008)
	TArray<UObject*>                                   Array;                                                    // 0x0038(0x0010) (ZeroConstructor)
};
