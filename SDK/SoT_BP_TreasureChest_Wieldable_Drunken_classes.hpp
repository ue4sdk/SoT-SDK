...
{
public:
	class UTankardRefillerComponent*                   TankardRefiller;                                          // 0x07D0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UDrunkenChestComponent*                      DrunkenChest;                                             // 0x07E0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
