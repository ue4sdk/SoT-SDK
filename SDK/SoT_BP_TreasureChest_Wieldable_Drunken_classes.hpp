...
{
public:
	class UTankardRefillerComponent*                   TankardRefiller;                                          // 0x07F8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UDrunkenChestComponent*                      DrunkenChest;                                             // 0x0808(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
