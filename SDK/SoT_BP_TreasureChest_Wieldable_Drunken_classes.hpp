...
{
public:
	class UTankardRefillerComponent*                   TankardRefiller;                                          // 0x07D8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UDrunkenChestComponent*                      DrunkenChest;                                             // 0x07E8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
