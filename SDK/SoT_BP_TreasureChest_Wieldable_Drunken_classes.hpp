...
{
public:
	class UTankardRefillerComponent*                   TankardRefiller;                                          // 0x07F0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UDrunkenChestComponent*                      DrunkenChest;                                             // 0x0800(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
