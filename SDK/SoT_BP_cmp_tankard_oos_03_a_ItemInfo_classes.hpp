...
#include "SoT_BP_cmp_tankard_oos_03_a_ItemInfo_structs.hpp"
...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_cmp_tankard_oos_03_a_ItemInfo.BP_cmp_tankard_oos_03_a_ItemInfo_C");
		return ptr;
	}
