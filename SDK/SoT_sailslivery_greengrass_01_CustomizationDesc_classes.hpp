...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass sailslivery_greengrass_01_CustomizationDesc.sailslivery_greengrass_01_CustomizationDesc_C");
		return ptr;
	}
