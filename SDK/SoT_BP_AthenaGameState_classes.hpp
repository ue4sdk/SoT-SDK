...
{
public:
	class UWorldMarkerRoutingComponent*                WorldMarkerRouting;                                       // 0x0AD0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USceneComponent*                             DefaultSceneRoot;                                         // 0x0AD8(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
