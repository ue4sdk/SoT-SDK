...
{
public:
	class UWorldMarkerRoutingComponent*                WorldMarkerRouting;                                       // 0x0A80(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USceneComponent*                             DefaultSceneRoot;                                         // 0x0A88(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
