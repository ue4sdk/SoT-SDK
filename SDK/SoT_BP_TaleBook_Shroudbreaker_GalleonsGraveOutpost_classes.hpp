...
#include "SoT_BP_TaleBook_Shroudbreaker_GalleonsGraveOutpost_structs.hpp"
...
// BlueprintGeneratedClass BP_TaleBook_Shroudbreaker_GalleonsGraveOutpost.BP_TaleBook_Shroudbreaker_GalleonsGraveOutpost_C
// 0x0030 (0x07D8 - 0x07A8)
class ABP_TaleBook_Shroudbreaker_GalleonsGraveOutpost_C : public AVoyageProposalContainer
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_TaleBook_Shroudbreaker_GalleonsGraveOutpost.BP_TaleBook_Shroudbreaker_GalleonsGraveOutpost_C"));
		return ptr;
	}
