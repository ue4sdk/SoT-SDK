...
public:
	...
	struct FADS_DeathNative                            Death;                                                    // 0x02C0(0x0020) (Edit, BlueprintVisible)
	struct FADS_CannonNative                           Cannon;                                                   // 0x02E0(0x0038) (Edit, BlueprintVisible)
	struct FADS_RowingBoatNative                       Rowboat;                                                  // 0x0318(0x0098) (Edit, BlueprintVisible)
	struct FADS_WaterPumpNative                        WaterPump;                                                // 0x03B0(0x0028) (Edit, BlueprintVisible)
	struct FADS_FacialNative                           Facial;                                                   // 0x03D8(0x0088) (Edit, BlueprintVisible)
