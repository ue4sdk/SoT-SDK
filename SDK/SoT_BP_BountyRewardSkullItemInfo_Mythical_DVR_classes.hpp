...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_BountyRewardSkullItemInfo_Mythical_DVR.BP_BountyRewardSkullItemInfo_Mythical_DVR_C");
		return ptr;
	}
