...
{
public:
	class UStaticMeshComponent*                        cmn_barrel_debris_01_a;                                   // 0x0490(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindObject<UClass>("BlueprintGeneratedClass BP_IslandStorageBarrel_Single_Cannonball_01.BP_IslandStorageBarrel_Single_Cannonball_01_C");
		return ptr;
	}
