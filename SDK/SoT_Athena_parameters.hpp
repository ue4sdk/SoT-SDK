...
struct UStatusEffectManagerComponent_OnRep_Statuses_Params
{
};
...
{
	TEnumAsByte<EBucketFillState>                      ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
