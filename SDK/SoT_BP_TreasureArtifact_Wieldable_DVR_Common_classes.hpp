...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_TreasureArtifact_Wieldable_DVR_Common.BP_TreasureArtifact_Wieldable_DVR_Common_C"));
		return ptr;
	}
