...
public:
	...
	class UAISpawner*                                  Spawner;                                                  // 0x0158(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UQuestBookPageBundle*                        DeathNote;                                                // 0x0160(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UQuestBookPageBundle*                        OurMemories;                                              // 0x0168(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TArray<class UAISpawner*>                          RookeEncounterSpawners;                                   // 0x0170(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
