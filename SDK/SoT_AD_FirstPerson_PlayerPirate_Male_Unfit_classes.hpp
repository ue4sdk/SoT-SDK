...
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass AD_FirstPerson_PlayerPirate_Male_Unfit.AD_FirstPerson_PlayerPirate_Male_Unfit_C"));
		return ptr;
	}
